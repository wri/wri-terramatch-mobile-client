...
export class PitchContactsApi {
    ...
    */
     ...
     */
    pitchContactsIDDeleteWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    pitchContactsIDDelete(ID) {
      return this.pitchContactsIDDeleteWithHttpInfo(ID)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PitchContactRead} and HTTP response
     */
    pitchContactsPostWithHttpInfo(Body) {
      let postBody = Body;
      ...
      let accepts = ['application/json'];
      let returnType = PitchContactRead;
     ...
     * Create a pitch contact
     * @param {module:model/PitchContactCreate} Body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PitchContactRead}
     */
    pitchContactsPost(Body) {
      return this.pitchContactsPostWithHttpInfo(Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PitchContactReadAll} and HTTP response
     */
    pitchesIDPitchContactsGetWithHttpInfo(ID) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PitchContactReadAll;
     ...
     * Read a pitch's pitch contacts
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PitchContactReadAll}
     */
    pitchesIDPitchContactsGet(ID) {
      return this.pitchesIDPitchContactsGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
