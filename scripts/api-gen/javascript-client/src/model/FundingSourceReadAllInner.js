 ...
 * @version 1.0.0
 */
export class FundingSourceReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new FundingSourceReadAllInner();
 ...
 * @member {String} name
 */
FundingSourceReadAllInner.prototype.name = undefined;

/**
 * @member {String} source
 */
FundingSourceReadAllInner.prototype.source = undefined;
