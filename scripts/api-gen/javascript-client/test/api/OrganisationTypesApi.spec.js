    ...
    describe('OrganisationTypesApi', function() {
      describe('organisationTypesGet', function() {
        it('should call organisationTypesGet successfully', function(done) {
          // TODO: uncomment organisationTypesGet call and complete the assertions
          /*

          instance.organisationTypesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationTypeReadAll);
