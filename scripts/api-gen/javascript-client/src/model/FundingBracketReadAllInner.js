 ...
 * @version 1.0.0
 */
export class FundingBracketReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new FundingBracketReadAllInner();
 ...
 * @member {String} name
 */
FundingBracketReadAllInner.prototype.name = undefined;

/**
 * @member {String} bracket
 */
FundingBracketReadAllInner.prototype.bracket = undefined;
