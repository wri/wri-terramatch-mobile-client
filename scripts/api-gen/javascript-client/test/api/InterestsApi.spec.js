    ...
    describe('InterestsApi', function() {
      describe('interestsIDDelete', function() {
        it('should call interestsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for interestsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.interestsIDDelete(ID).then(function(data) {
      ...
      describe('interestsInitiatedGet', function() {
        it('should call interestsInitiatedGet successfully', function(done) {
          // TODO: uncomment interestsInitiatedGet call and complete the assertions
          /*

          instance.interestsInitiatedGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.InterestReadAll);
      ...
      describe('interestsPost', function() {
        it('should call interestsPost successfully', function(done) {
          // TODO: uncomment, update parameter values for interestsPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.InterestCreate();
          Body.initiator = "";
          Body.offer_id = 0;
          Body.pitch_id = 0;

          instance.interestsPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.InterestRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
            expect(data.organisation_id).to.be.a('number');
            // expect(data.organisation_id).to.be(0);
            expect(data.initiator).to.be.a('string');
            // expect(data.initiator).to.be("");
      ...
      describe('interestsReceivedGet', function() {
        it('should call interestsReceivedGet successfully', function(done) {
          // TODO: uncomment interestsReceivedGet call and complete the assertions
          /*

          instance.interestsReceivedGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.InterestReadAll);
