 ...
 * @version 1.0.0
 */
export class OfferDocumentUpdate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OfferDocumentUpdate();
 ...
 * @member {String} name
 */
OfferDocumentUpdate.prototype.name = undefined;

/**
 * @member {String} type
 */
OfferDocumentUpdate.prototype.type = undefined;

/**
 * @member {Number} document
 */
OfferDocumentUpdate.prototype.document = undefined;
