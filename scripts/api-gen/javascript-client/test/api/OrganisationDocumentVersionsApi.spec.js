    ...
    describe('OrganisationDocumentVersionsApi', function() {
      describe('organisationDocumentVersionsIDApprovePatch', function() {
        it('should call organisationDocumentVersionsIDApprovePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationDocumentVersionsIDApprovePatch call and complete the assertions
          /*
          var ID = 56;

          instance.organisationDocumentVersionsIDApprovePatch(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentVersionRead);
            ...
            expect(data.data).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentRead);
      ...
      describe('organisationDocumentVersionsIDDelete', function() {
        it('should call organisationDocumentVersionsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationDocumentVersionsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.organisationDocumentVersionsIDDelete(ID).then(function(data) {
            // TODO: update response assertions
      ...
      describe('organisationDocumentVersionsIDGet', function() {
        it('should call organisationDocumentVersionsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationDocumentVersionsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationDocumentVersionsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('organisationDocumentVersionsIDRejectPatch', function() {
        it('should call organisationDocumentVersionsIDRejectPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationDocumentVersionsIDRejectPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.OrganisationDocumentVersionReject();
          Body.rejected_reason = "";
          Body.rejected_reason_body = "";

          instance.organisationDocumentVersionsIDRejectPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('organisationDocumentVersionsIDRevivePatch', function() {
        it('should call organisationDocumentVersionsIDRevivePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationDocumentVersionsIDRevivePatch call and complete the assertions
          /*
          var ID = 56;

          instance.organisationDocumentVersionsIDRevivePatch(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('organisationDocumentsIDOrganisationDocumentVersionsGet', function() {
        it('should call organisationDocumentsIDOrganisationDocumentVersionsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationDocumentsIDOrganisationDocumentVersionsGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationDocumentsIDOrganisationDocumentVersionsGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentVersionReadAll);
