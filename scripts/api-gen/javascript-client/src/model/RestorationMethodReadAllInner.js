 ...
 * @version 1.0.0
 */
export class RestorationMethodReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RestorationMethodReadAllInner();
 ...
 * @member {String} name
 */
RestorationMethodReadAllInner.prototype.name = undefined;

/**
 * @member {String} method
 */
RestorationMethodReadAllInner.prototype.method = undefined;
