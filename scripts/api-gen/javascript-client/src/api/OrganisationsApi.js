...
export class OrganisationsApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationReadAll} and HTTP response
     */
    organisationsGetWithHttpInfo() {
      let postBody = null;
      ...
      let returnType = OrganisationReadAll;
    ...
    /**
     * Read all organisations
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationReadAll}
     */
    organisationsGet() {
      return this.organisationsGetWithHttpInfo()
     ...
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/MaskedOrganisationRead} and HTTP response
     */
    organisationsIDGetWithHttpInfo(ID) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = MaskedOrganisationRead;
     ...
     * Read an organisation
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/MaskedOrganisationRead}
     */
    organisationsIDGet(ID) {
      return this.organisationsIDGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationRead} and HTTP response
     */
    organisationsIDInspectGetWithHttpInfo(ID) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = OrganisationRead;
     ...
     * Inspect an organisation
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationRead}
     */
    organisationsIDInspectGet(ID) {
      return this.organisationsIDInspectGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationVersionRead} and HTTP response
     */
    organisationsIDPatchWithHttpInfo(ID, Body) {
      let postBody = Body;
      ...
      let accepts = ['application/json'];
      let returnType = OrganisationVersionRead;
     ...
     * @param {Number} ID 
     * @param {module:model/OrganisationUpdate} Body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationVersionRead}
     */
    organisationsIDPatch(ID, Body) {
      return this.organisationsIDPatchWithHttpInfo(ID, Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationVersionRead} and HTTP response
     */
    organisationsPostWithHttpInfo(Body) {
      let postBody = Body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationVersionRead}
     */
    organisationsPost(Body) {
      return this.organisationsPostWithHttpInfo(Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
