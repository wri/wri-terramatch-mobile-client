    ...
    describe('RestorationGoalsApi', function() {
      describe('restorationGoalsGet', function() {
        it('should call restorationGoalsGet successfully', function(done) {
          // TODO: uncomment restorationGoalsGet call and complete the assertions
          /*

          instance.restorationGoalsGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.RestorationGoalReadAll);
