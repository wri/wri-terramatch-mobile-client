    ...
    describe('SustainableDevelopmentGoalsApi', function() {
      describe('sustainableDevelopmentGoalsGet', function() {
        it('should call sustainableDevelopmentGoalsGet successfully', function(done) {
          // TODO: uncomment sustainableDevelopmentGoalsGet call and complete the assertions
          /*

          instance.sustainableDevelopmentGoalsGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.SustainableDevelopmentGoalReadAll);
