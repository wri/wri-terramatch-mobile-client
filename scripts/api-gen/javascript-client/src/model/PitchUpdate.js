 ...
 * @member {String} name
 */
PitchUpdate.prototype.name = undefined;

/**
 * @member {String} description
 */
PitchUpdate.prototype.description = undefined;

/**
 * @member {Array.<String>} land_types
 */
PitchUpdate.prototype.land_types = undefined;

/**
 * @member {Array.<String>} land_ownerships
 */
PitchUpdate.prototype.land_ownerships = undefined;

/**
 * @member {String} land_size
 */
PitchUpdate.prototype.land_size = undefined;

/**
 * @member {String} land_continent
 */
PitchUpdate.prototype.land_continent = undefined;

/**
 * @member {String} land_country
 */
PitchUpdate.prototype.land_country = undefined;

/**
 * @member {String} land_geojson
 */
PitchUpdate.prototype.land_geojson = undefined;

/**
 * @member {Array.<String>} restoration_methods
 */
PitchUpdate.prototype.restoration_methods = undefined;

/**
 * @member {Array.<String>} restoration_goals
 */
PitchUpdate.prototype.restoration_goals = undefined;

/**
 * @member {Array.<String>} funding_sources
 */
PitchUpdate.prototype.funding_sources = undefined;

/**
 * @member {Number} funding_amount
 */
PitchUpdate.prototype.funding_amount = undefined;

/**
 * @member {String} funding_bracket
 */
PitchUpdate.prototype.funding_bracket = undefined;

/**
 * @member {Array.<String>} revenue_drivers
 */
PitchUpdate.prototype.revenue_drivers = undefined;

/**
 * @member {Number} estimated_timespan
 */
PitchUpdate.prototype.estimated_timespan = undefined;

/**
 * @member {Boolean} long_term_engagement
 */
PitchUpdate.prototype.long_term_engagement = undefined;

/**
 * @member {String} reporting_frequency
 */
PitchUpdate.prototype.reporting_frequency = undefined;

/**
 * @member {String} reporting_level
 */
PitchUpdate.prototype.reporting_level = undefined;

/**
 * @member {Array.<String>} sustainable_development_goals
 */
PitchUpdate.prototype.sustainable_development_goals = undefined;

/**
 * @member {Number} cover_photo
 */
PitchUpdate.prototype.cover_photo = undefined;

/**
 * @member {Number} video
 */
PitchUpdate.prototype.video = undefined;

/**
 * @member {String} problem
 */
PitchUpdate.prototype.problem = undefined;

/**
 * @member {String} anticipated_outcome
 */
PitchUpdate.prototype.anticipated_outcome = undefined;

/**
 * @member {String} who_is_involved
 */
PitchUpdate.prototype.who_is_involved = undefined;

/**
 * @member {Boolean} local_community_involvement
 */
PitchUpdate.prototype.local_community_involvement = undefined;

/**
 * @member {Boolean} training_involved
 */
PitchUpdate.prototype.training_involved = undefined;

/**
 * @member {String} training_type
 */
PitchUpdate.prototype.training_type = undefined;

/**
 * @member {Number} training_amount_people
 */
PitchUpdate.prototype.training_amount_people = undefined;

/**
 * @member {String} people_working_in
 */
PitchUpdate.prototype.people_working_in = undefined;

/**
 * @member {Number} people_amount_nearby
 */
PitchUpdate.prototype.people_amount_nearby = undefined;

/**
 * @member {Number} people_amount_abroad
 */
PitchUpdate.prototype.people_amount_abroad = undefined;

/**
 * @member {Number} people_amount_employees
 */
PitchUpdate.prototype.people_amount_employees = undefined;

/**
 * @member {Number} people_amount_volunteers
 */
PitchUpdate.prototype.people_amount_volunteers = undefined;

/**
 * @member {Number} benefited_people
 */
PitchUpdate.prototype.benefited_people = undefined;

/**
 * @member {String} future_maintenance
 */
PitchUpdate.prototype.future_maintenance = undefined;

/**
 * @member {String} use_of_resources
 */
PitchUpdate.prototype.use_of_resources = undefined;
