    ...
    describe('OrganisationCategoriesApi', function() {
      describe('organisationCategoriesGet', function() {
        it('should call organisationCategoriesGet successfully', function(done) {
          // TODO: uncomment organisationCategoriesGet call and complete the assertions
          /*

          instance.organisationCategoriesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationCategoryReadAll);
