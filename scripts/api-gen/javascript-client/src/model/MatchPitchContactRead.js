 ...
 * @version 1.0.0
 */
export class MatchPitchContactRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new MatchPitchContactRead();
 ...
 * @member {Number} id
 */
MatchPitchContactRead.prototype.id = undefined;

/**
 * @member {String} model
 */
MatchPitchContactRead.prototype.model = undefined;

/**
 * @member {Number} pitch_id
 */
MatchPitchContactRead.prototype.pitch_id = undefined;

/**
 * @member {String} first_name
 */
MatchPitchContactRead.prototype.first_name = undefined;

/**
 * @member {String} last_name
 */
MatchPitchContactRead.prototype.last_name = undefined;

/**
 * @member {String} avatar
 */
MatchPitchContactRead.prototype.avatar = undefined;

/**
 * @member {String} email_address
 */
MatchPitchContactRead.prototype.email_address = undefined;

/**
 * @member {String} phone_number
 */
MatchPitchContactRead.prototype.phone_number = undefined;

/**
 * @member {String} job_role
 */
MatchPitchContactRead.prototype.job_role = undefined;

/**
 * @member {String} facebook
 */
MatchPitchContactRead.prototype.facebook = undefined;

/**
 * @member {String} twitter
 */
MatchPitchContactRead.prototype.twitter = undefined;

/**
 * @member {String} instagram
 */
MatchPitchContactRead.prototype.instagram = undefined;

/**
 * @member {String} linkedin
 */
MatchPitchContactRead.prototype.linkedin = undefined;
