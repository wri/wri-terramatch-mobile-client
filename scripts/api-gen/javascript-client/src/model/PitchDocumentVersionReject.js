 ...
 * @version 1.0.0
 */
export class PitchDocumentVersionReject {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PitchDocumentVersionReject();
 ...
 */
PitchDocumentVersionReject.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
PitchDocumentVersionReject.prototype.rejected_reason_body = undefined;
