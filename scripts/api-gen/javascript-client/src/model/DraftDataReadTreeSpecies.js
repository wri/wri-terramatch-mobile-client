 ...
 * @version 1.0.0
 */
export class DraftDataReadTreeSpecies {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DraftDataReadTreeSpecies();
 ...
 * @member {String} name
 */
DraftDataReadTreeSpecies.prototype.name = undefined;

/**
 * @member {Boolean} is_native
 */
DraftDataReadTreeSpecies.prototype.is_native = undefined;

/**
 * @member {Number} count
 */
DraftDataReadTreeSpecies.prototype.count = undefined;

/**
 * @member {Number} price_to_plant
 */
DraftDataReadTreeSpecies.prototype.price_to_plant = undefined;

/**
 * @member {Number} price_to_maintain
 */
DraftDataReadTreeSpecies.prototype.price_to_maintain = undefined;

/**
 * @member {Number} saplings
 */
DraftDataReadTreeSpecies.prototype.saplings = undefined;

/**
 * @member {Number} site_prep
 */
DraftDataReadTreeSpecies.prototype.site_prep = undefined;

/**
 * @member {Number} survival_rate
 */
DraftDataReadTreeSpecies.prototype.survival_rate = undefined;

/**
 * @member {Boolean} produces_food
 */
DraftDataReadTreeSpecies.prototype.produces_food = undefined;

/**
 * @member {Boolean} produces_firewood
 */
DraftDataReadTreeSpecies.prototype.produces_firewood = undefined;

/**
 * @member {Boolean} produces_timber
 */
DraftDataReadTreeSpecies.prototype.produces_timber = undefined;

/**
 * @member {String} owner
 */
DraftDataReadTreeSpecies.prototype.owner = undefined;

/**
 * @member {String} season
 */
DraftDataReadTreeSpecies.prototype.season = undefined;
