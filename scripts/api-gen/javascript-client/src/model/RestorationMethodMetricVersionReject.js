 ...
 * @version 1.0.0
 */
export class RestorationMethodMetricVersionReject {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RestorationMethodMetricVersionReject();
 ...
 */
RestorationMethodMetricVersionReject.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
RestorationMethodMetricVersionReject.prototype.rejected_reason_body = undefined;
