...
import {PitchDocumentRead} from './PitchDocumentRead';
 ...
 * @version 1.0.0
 */
export class PitchDocumentVersionRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PitchDocumentVersionRead();
 ...
 * @member {Number} id
 */
PitchDocumentVersionRead.prototype.id = undefined;

/**
 * @member {String} status
 */
PitchDocumentVersionRead.prototype.status = undefined;

/**
 * @member {String} rejected_reason
 */
PitchDocumentVersionRead.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
PitchDocumentVersionRead.prototype.rejected_reason_body = undefined;

/**
 * @member {Number} approved_rejected_by
 */
PitchDocumentVersionRead.prototype.approved_rejected_by = undefined;

/**
 * @member {Date} approved_rejected_at
 */
PitchDocumentVersionRead.prototype.approved_rejected_at = undefined;

/**
 * @member {Date} created_at
 */
PitchDocumentVersionRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
PitchDocumentVersionRead.prototype.updated_at = undefined;

/**
 * @member {module:model/PitchDocumentRead} data
 */
PitchDocumentVersionRead.prototype.data = undefined;
