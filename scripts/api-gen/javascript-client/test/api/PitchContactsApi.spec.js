    ...
    describe('PitchContactsApi', function() {
      describe('pitchContactsIDDelete', function() {
        it('should call pitchContactsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchContactsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.pitchContactsIDDelete(ID).then(function(data) {
      ...
      describe('pitchContactsPost', function() {
        it('should call pitchContactsPost successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchContactsPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.PitchContactCreate();
          Body.pitch_id = 0;
          Body.user_id = 0;
          Body.team_member_id = 0;

          instance.pitchContactsPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.PitchContactRead);
      ...
      describe('pitchesIDPitchContactsGet', function() {
        it('should call pitchesIDPitchContactsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchesIDPitchContactsGet call and complete the assertions
          /*
          var ID = 56;

          instance.pitchesIDPitchContactsGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.PitchContactReadAll);
