 ...
 * @version 1.0.0
 */
export class OrganisationCategoryReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationCategoryReadAllInner();
 ...
 * @member {String} name
 */
OrganisationCategoryReadAllInner.prototype.name = undefined;

/**
 * @member {String} category
 */
OrganisationCategoryReadAllInner.prototype.category = undefined;
