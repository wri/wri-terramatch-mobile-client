 ...
 * @version 1.0.0
 */
export class CarbonCertificationUpdate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CarbonCertificationUpdate();
 ...
 * @member {String} type
 */
CarbonCertificationUpdate.prototype.type = undefined;

/**
 * @member {String} other_value
 */
CarbonCertificationUpdate.prototype.other_value = undefined;

/**
 * @member {String} link
 */
CarbonCertificationUpdate.prototype.link = undefined;
