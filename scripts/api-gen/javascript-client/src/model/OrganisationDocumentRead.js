 ...
 * @version 1.0.0
 */
export class OrganisationDocumentRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationDocumentRead();
 ...
 * @member {Number} id
 */
OrganisationDocumentRead.prototype.id = undefined;

/**
 * @member {Number} organisation_id
 */
OrganisationDocumentRead.prototype.organisation_id = undefined;

/**
 * @member {String} name
 */
OrganisationDocumentRead.prototype.name = undefined;

/**
 * @member {String} type
 */
OrganisationDocumentRead.prototype.type = undefined;

/**
 * @member {String} document
 */
OrganisationDocumentRead.prototype.document = undefined;

/**
 * @member {Date} created_at
 */
OrganisationDocumentRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
OrganisationDocumentRead.prototype.updated_at = undefined;
