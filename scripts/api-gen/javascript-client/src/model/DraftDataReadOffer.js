 ...
 * @version 1.0.0
 */
export class DraftDataReadOffer {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DraftDataReadOffer();
 ...
 * @member {String} name
 */
DraftDataReadOffer.prototype.name = undefined;

/**
 * @member {String} description
 */
DraftDataReadOffer.prototype.description = undefined;

/**
 * @member {Array.<String>} land_types
 */
DraftDataReadOffer.prototype.land_types = undefined;

/**
 * @member {Array.<String>} land_ownerships
 */
DraftDataReadOffer.prototype.land_ownerships = undefined;

/**
 * @member {String} land_size
 */
DraftDataReadOffer.prototype.land_size = undefined;

/**
 * @member {String} land_continent
 */
DraftDataReadOffer.prototype.land_continent = undefined;

/**
 * @member {String} land_country
 */
DraftDataReadOffer.prototype.land_country = undefined;

/**
 * @member {Array.<String>} restoration_methods
 */
DraftDataReadOffer.prototype.restoration_methods = undefined;

/**
 * @member {Array.<String>} restoration_goals
 */
DraftDataReadOffer.prototype.restoration_goals = undefined;

/**
 * @member {Array.<String>} funding_sources
 */
DraftDataReadOffer.prototype.funding_sources = undefined;

/**
 * @member {Number} funding_amount
 */
DraftDataReadOffer.prototype.funding_amount = undefined;

/**
 * @member {String} funding_bracket
 */
DraftDataReadOffer.prototype.funding_bracket = undefined;

/**
 * @member {Number} price_per_tree
 */
DraftDataReadOffer.prototype.price_per_tree = undefined;

/**
 * @member {Boolean} long_term_engagement
 */
DraftDataReadOffer.prototype.long_term_engagement = undefined;

/**
 * @member {String} reporting_frequency
 */
DraftDataReadOffer.prototype.reporting_frequency = undefined;

/**
 * @member {String} reporting_level
 */
DraftDataReadOffer.prototype.reporting_level = undefined;

/**
 * @member {Array.<String>} sustainable_development_goals
 */
DraftDataReadOffer.prototype.sustainable_development_goals = undefined;

/**
 * @member {String} cover_photo
 */
DraftDataReadOffer.prototype.cover_photo = undefined;

/**
 * @member {String} video
 */
DraftDataReadOffer.prototype.video = undefined;
