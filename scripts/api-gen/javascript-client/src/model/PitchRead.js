 ...
 * @member {Number} id
 */
PitchRead.prototype.id = undefined;

/**
 * @member {Number} organisation_id
 */
PitchRead.prototype.organisation_id = undefined;

/**
 * @member {String} name
 */
PitchRead.prototype.name = undefined;

/**
 * @member {String} description
 */
PitchRead.prototype.description = undefined;

/**
 * @member {Array.<String>} land_types
 */
PitchRead.prototype.land_types = undefined;

/**
 * @member {Array.<String>} land_ownerships
 */
PitchRead.prototype.land_ownerships = undefined;

/**
 * @member {String} land_size
 */
PitchRead.prototype.land_size = undefined;

/**
 * @member {String} land_continent
 */
PitchRead.prototype.land_continent = undefined;

/**
 * @member {String} land_country
 */
PitchRead.prototype.land_country = undefined;

/**
 * @member {String} land_geojson
 */
PitchRead.prototype.land_geojson = undefined;

/**
 * @member {Array.<String>} restoration_methods
 */
PitchRead.prototype.restoration_methods = undefined;

/**
 * @member {Array.<String>} restoration_goals
 */
PitchRead.prototype.restoration_goals = undefined;

/**
 * @member {Array.<String>} funding_sources
 */
PitchRead.prototype.funding_sources = undefined;

/**
 * @member {Number} funding_amount
 */
PitchRead.prototype.funding_amount = undefined;

/**
 * @member {String} funding_bracket
 */
PitchRead.prototype.funding_bracket = undefined;

/**
 * @member {Array.<String>} revenue_drivers
 */
PitchRead.prototype.revenue_drivers = undefined;

/**
 * @member {Number} estimated_timespan
 */
PitchRead.prototype.estimated_timespan = undefined;

/**
 * @member {Boolean} long_term_engagement
 */
PitchRead.prototype.long_term_engagement = undefined;

/**
 * @member {String} reporting_frequency
 */
PitchRead.prototype.reporting_frequency = undefined;

/**
 * @member {String} reporting_level
 */
PitchRead.prototype.reporting_level = undefined;

/**
 * @member {Array.<String>} sustainable_development_goals
 */
PitchRead.prototype.sustainable_development_goals = undefined;

/**
 * @member {String} avatar
 */
PitchRead.prototype.avatar = undefined;

/**
 * @member {String} cover_photo
 */
PitchRead.prototype.cover_photo = undefined;

/**
 * @member {String} video
 */
PitchRead.prototype.video = undefined;

/**
 * @member {String} problem
 */
PitchRead.prototype.problem = undefined;

/**
 * @member {String} anticipated_outcome
 */
PitchRead.prototype.anticipated_outcome = undefined;

/**
 * @member {String} who_is_involved
 */
PitchRead.prototype.who_is_involved = undefined;

/**
 * @member {Boolean} local_community_involvement
 */
PitchRead.prototype.local_community_involvement = undefined;

/**
 * @member {Boolean} training_involved
 */
PitchRead.prototype.training_involved = undefined;

/**
 * @member {String} training_type
 */
PitchRead.prototype.training_type = undefined;

/**
 * @member {Number} training_amount_people
 */
PitchRead.prototype.training_amount_people = undefined;

/**
 * @member {String} people_working_in
 */
PitchRead.prototype.people_working_in = undefined;

/**
 * @member {Number} people_amount_nearby
 */
PitchRead.prototype.people_amount_nearby = undefined;

/**
 * @member {Number} people_amount_abroad
 */
PitchRead.prototype.people_amount_abroad = undefined;

/**
 * @member {Number} people_amount_employees
 */
PitchRead.prototype.people_amount_employees = undefined;

/**
 * @member {Number} people_amount_volunteers
 */
PitchRead.prototype.people_amount_volunteers = undefined;

/**
 * @member {Number} benefited_people
 */
PitchRead.prototype.benefited_people = undefined;

/**
 * @member {String} future_maintenance
 */
PitchRead.prototype.future_maintenance = undefined;

/**
 * @member {String} use_of_resources
 */
PitchRead.prototype.use_of_resources = undefined;

/**
 * @member {Date} created_at
 */
PitchRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
PitchRead.prototype.updated_at = undefined;

/**
 * @member {Boolean} completed
 */
PitchRead.prototype.completed = undefined;

/**
 * @member {Boolean} successful
 */
PitchRead.prototype.successful = undefined;

/**
 * @member {Number} compatibility_score
 */
PitchRead.prototype.compatibility_score = undefined;

/**
 * @member {Number} price_per_tree
 */
PitchRead.prototype.price_per_tree = undefined;

/**
 * @member {String} visibility
 */
PitchRead.prototype.visibility = undefined;
