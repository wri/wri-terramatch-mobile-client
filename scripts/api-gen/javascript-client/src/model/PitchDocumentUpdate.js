 ...
 * @version 1.0.0
 */
export class PitchDocumentUpdate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PitchDocumentUpdate();
 ...
 * @member {String} name
 */
PitchDocumentUpdate.prototype.name = undefined;

/**
 * @member {String} type
 */
PitchDocumentUpdate.prototype.type = undefined;

/**
 * @member {Number} document
 */
PitchDocumentUpdate.prototype.document = undefined;
