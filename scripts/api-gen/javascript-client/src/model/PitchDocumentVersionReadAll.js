...
import {PitchDocumentVersionRead} from './PitchDocumentVersionRead';
 ...
 * @version 1.0.0
 */
export class PitchDocumentVersionReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PitchDocumentVersionReadAll();
