 ...
 * @version 1.0.0
 */
export class RestorationGoalReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RestorationGoalReadAllInner();
 ...
 * @member {String} name
 */
RestorationGoalReadAllInner.prototype.name = undefined;

/**
 * @member {String} goal
 */
RestorationGoalReadAllInner.prototype.goal = undefined;
