...
import {RestorationGoalReadAllInner} from './RestorationGoalReadAllInner';
 ...
 * @version 1.0.0
 */
export class SustainableDevelopmentGoalReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SustainableDevelopmentGoalReadAll();
