 ...
 * @version 1.0.0
 */
export class MaskedTeamMemberRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new MaskedTeamMemberRead();
 ...
 * @member {Number} id
 */
MaskedTeamMemberRead.prototype.id = undefined;

/**
 * @member {Number} organisation_id
 */
MaskedTeamMemberRead.prototype.organisation_id = undefined;

/**
 * @member {String} first_name
 */
MaskedTeamMemberRead.prototype.first_name = undefined;

/**
 * @member {String} last_name
 */
MaskedTeamMemberRead.prototype.last_name = undefined;

/**
 * @member {String} job_role
 */
MaskedTeamMemberRead.prototype.job_role = undefined;

/**
 * @member {String} facebook
 */
MaskedTeamMemberRead.prototype.facebook = undefined;

/**
 * @member {String} twitter
 */
MaskedTeamMemberRead.prototype.twitter = undefined;

/**
 * @member {String} instagram
 */
MaskedTeamMemberRead.prototype.instagram = undefined;

/**
 * @member {String} linkedin
 */
MaskedTeamMemberRead.prototype.linkedin = undefined;

/**
 * @member {String} avatar
 */
MaskedTeamMemberRead.prototype.avatar = undefined;
