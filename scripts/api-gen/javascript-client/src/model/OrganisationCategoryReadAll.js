...
import {OrganisationCategoryReadAllInner} from './OrganisationCategoryReadAllInner';
 ...
 * @version 1.0.0
 */
export class OrganisationCategoryReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationCategoryReadAll();
