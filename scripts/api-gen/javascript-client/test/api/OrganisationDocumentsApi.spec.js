    ...
    describe('OrganisationDocumentsApi', function() {
      describe('organisationDocumentsIDDelete', function() {
        it('should call organisationDocumentsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationDocumentsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.organisationDocumentsIDDelete(ID).then(function(data) {
      ...
      describe('organisationDocumentsIDGet', function() {
        it('should call organisationDocumentsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationDocumentsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationDocumentsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentRead);
      ...
      describe('organisationDocumentsIDPatch', function() {
        it('should call organisationDocumentsIDPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationDocumentsIDPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.OrganisationDocumentUpdate();
          Body.name = "";
          Body.type = "";
          Body.document = 0;

          instance.organisationDocumentsIDPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
      ...
      describe('organisationDocumentsPost', function() {
        it('should call organisationDocumentsPost successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationDocumentsPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.OrganisationDocumentCreate();
          Body.name = "";
          Body.type = "";
          Body.document = 0;

          instance.organisationDocumentsPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('organisationsIDOrganisationDocumentsGet', function() {
        it('should call organisationsIDOrganisationDocumentsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationsIDOrganisationDocumentsGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationsIDOrganisationDocumentsGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentReadAll);
      ...
      describe('organisationsIDOrganisationDocumentsInspectGet', function() {
        it('should call organisationsIDOrganisationDocumentsInspectGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationsIDOrganisationDocumentsInspectGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationsIDOrganisationDocumentsInspectGet(ID).then(function(data) {
            // TODO: update response assertions
