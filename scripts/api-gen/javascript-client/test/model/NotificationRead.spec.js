  ...
  describe('(package)', function() {
    describe('NotificationRead', function() {
      ...
      it('should create an instance of NotificationRead', function() {
        // TODO: update the code to test NotificationRead
      ...
      it('should have the property referenced_model (base name: "referenced_model")', function() {
        // TODO: update the code to test the property referenced_model
        expect(instance).to.have.property('referenced_model');
        // expect(instance.referenced_model).to.be(expectedValueLiteral);
      });

      it('should have the property referenced_model_id (base name: "referenced_model_id")', function() {
        // TODO: update the code to test the property referenced_model_id
        expect(instance).to.have.property('referenced_model_id');
        // expect(instance.referenced_model_id).to.be(expectedValueLiteral);
      });
