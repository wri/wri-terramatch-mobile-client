 ...
 * @version 1.0.0
 */
export class CarbonCertificationVersionReject {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CarbonCertificationVersionReject();
 ...
 */
CarbonCertificationVersionReject.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
CarbonCertificationVersionReject.prototype.rejected_reason_body = undefined;
