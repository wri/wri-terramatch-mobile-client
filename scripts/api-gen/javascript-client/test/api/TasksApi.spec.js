    ...
    describe('TasksApi', function() {
      describe('tasksMatchesGet', function() {
        it('should call tasksMatchesGet successfully', function(done) {
          // TODO: uncomment tasksMatchesGet call and complete the assertions
          /*

          instance.tasksMatchesGet().then(function(data) {
      ...
      describe('tasksOrganisationsGet', function() {
        it('should call tasksOrganisationsGet successfully', function(done) {
          // TODO: uncomment tasksOrganisationsGet call and complete the assertions
          /*

          instance.tasksOrganisationsGet().then(function(data) {
            // TODO: update response assertions
      ...
      describe('tasksPitchesGet', function() {
        it('should call tasksPitchesGet successfully', function(done) {
          // TODO: uncomment tasksPitchesGet call and complete the assertions
          /*

          instance.tasksPitchesGet().then(function(data) {
            // TODO: update response assertions
