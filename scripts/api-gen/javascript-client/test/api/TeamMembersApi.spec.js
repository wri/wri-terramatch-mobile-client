    ...
    describe('TeamMembersApi', function() {
      describe('organisationsIDTeamMembersGet', function() {
        it('should call organisationsIDTeamMembersGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationsIDTeamMembersGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationsIDTeamMembersGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.MaskedTeamMemberReadAll);
      ...
      describe('organisationsIDTeamMembersInspectGet', function() {
        it('should call organisationsIDTeamMembersInspectGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationsIDTeamMembersInspectGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationsIDTeamMembersInspectGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.TeamMemberReadAll);
      ...
      describe('teamMembersIDDelete', function() {
        it('should call teamMembersIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for teamMembersIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.teamMembersIDDelete(ID).then(function(data) {
            // TODO: update response assertions
      ...
      describe('teamMembersIDGet', function() {
        it('should call teamMembersIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for teamMembersIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.teamMembersIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.TeamMemberRead);
      ...
      describe('teamMembersIDPatch', function() {
        it('should call teamMembersIDPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for teamMembersIDPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.TeamMemberUpdate();
          Body.first_name = "";
          Body.last_name = "";
          Body.job_role = "";
          Body.facebook = "";
          ...
          instance.teamMembersIDPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.TeamMemberRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('teamMembersPost', function() {
        it('should call teamMembersPost successfully', function(done) {
          // TODO: uncomment, update parameter values for teamMembersPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.TeamMemberCreate();
          Body.first_name = "";
          Body.last_name = "";
          Body.job_role = "";
          Body.facebook = "";
          ...
          instance.teamMembersPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.TeamMemberRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
