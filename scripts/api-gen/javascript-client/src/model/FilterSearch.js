 ...
 * @member {Number} page
 */
FilterSearch.prototype.page = undefined;
 ...
 * @readonly
 */
FilterSearch.SortAttributeEnum = {
  /**
   * value: "created_at"
   * @const
   */
...
/**
 * @member {module:model/FilterSearch.SortAttributeEnum} sortAttribute
 */
FilterSearch.prototype.sortAttribute = undefined;
 ...
 * @readonly
 */
FilterSearch.SortDirectionEnum = {
  /**
   * value: "asc"
   * @const
   */
...
/**
 * @member {module:model/FilterSearch.SortDirectionEnum} sortDirection
 */
FilterSearch.prototype.sortDirection = undefined;

/**
 * @member {Array.<module:model/FilterCondition>} filters
 */
FilterSearch.prototype.filters = undefined;
