    ...
    describe('UploadsApi', function() {
      describe('uploadsPost', function() {
        it('should call uploadsPost successfully', function(done) {
          // TODO: uncomment, update parameter values for uploadsPost call and complete the assertions
          /*
          var upload = "/path/to/file.txt";

          instance.uploadsPost(upload).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.UploadCreate);
