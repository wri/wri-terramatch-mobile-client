  ...
  describe('(package)', function() {
    describe('AdminRead', function() {
      ...
      it('should create an instance of AdminRead', function() {
        // TODO: update the code to test AdminRead
      ...
      it('should have the property email_address_verified_at (base name: "email_address_verified_at")', function() {
        // TODO: update the code to test the property email_address_verified_at
        expect(instance).to.have.property('email_address_verified_at');
        // expect(instance.email_address_verified_at).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property last_logged_in_at (base name: "last_logged_in_at")', function() {
        // TODO: update the code to test the property last_logged_in_at
        expect(instance).to.have.property('last_logged_in_at');
        // expect(instance.last_logged_in_at).to.be(expectedValueLiteral);
      });
