 ...
 * @version 1.0.0
 */
export class MatchOfferContactRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new MatchOfferContactRead();
 ...
 * @member {Number} id
 */
MatchOfferContactRead.prototype.id = undefined;

/**
 * @member {String} model
 */
MatchOfferContactRead.prototype.model = undefined;

/**
 * @member {Number} offer_id
 */
MatchOfferContactRead.prototype.offer_id = undefined;

/**
 * @member {String} first_name
 */
MatchOfferContactRead.prototype.first_name = undefined;

/**
 * @member {String} last_name
 */
MatchOfferContactRead.prototype.last_name = undefined;

/**
 * @member {String} avatar
 */
MatchOfferContactRead.prototype.avatar = undefined;

/**
 * @member {String} email_address
 */
MatchOfferContactRead.prototype.email_address = undefined;

/**
 * @member {String} phone_number
 */
MatchOfferContactRead.prototype.phone_number = undefined;

/**
 * @member {String} job_role
 */
MatchOfferContactRead.prototype.job_role = undefined;

/**
 * @member {String} facebook
 */
MatchOfferContactRead.prototype.facebook = undefined;

/**
 * @member {String} twitter
 */
MatchOfferContactRead.prototype.twitter = undefined;

/**
 * @member {String} instagram
 */
MatchOfferContactRead.prototype.instagram = undefined;

/**
 * @member {String} linkedin
 */
MatchOfferContactRead.prototype.linkedin = undefined;
