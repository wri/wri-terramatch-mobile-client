 ...
 * @version 1.0.0
 */
export class TreeSpeciesVersionReject {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TreeSpeciesVersionReject();
 ...
 */
TreeSpeciesVersionReject.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
TreeSpeciesVersionReject.prototype.rejected_reason_body = undefined;
