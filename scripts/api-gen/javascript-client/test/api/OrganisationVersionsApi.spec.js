    ...
    describe('OrganisationVersionsApi', function() {
      describe('organisationVersionsIDApprovePatch', function() {
        it('should call organisationVersionsIDApprovePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationVersionsIDApprovePatch call and complete the assertions
          /*
          var ID = 56;

          instance.organisationVersionsIDApprovePatch(ID).then(function(data) {
      ...
      describe('organisationVersionsIDDelete', function() {
        it('should call organisationVersionsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationVersionsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.organisationVersionsIDDelete(ID).then(function(data) {
            // TODO: update response assertions
      ...
      describe('organisationVersionsIDGet', function() {
        it('should call organisationVersionsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationVersionsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationVersionsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('organisationVersionsIDRejectPatch', function() {
        it('should call organisationVersionsIDRejectPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationVersionsIDRejectPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.OrganisationVersionReject();
          Body.rejected_reason = "";
          Body.rejected_reason_body = "";

          instance.organisationVersionsIDRejectPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('organisationVersionsIDRevivePatch', function() {
        it('should call organisationVersionsIDRevivePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationVersionsIDRevivePatch call and complete the assertions
          /*
          var ID = 56;

          instance.organisationVersionsIDRevivePatch(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('organisationsIDOrganisationVersionsGet', function() {
        it('should call organisationsIDOrganisationVersionsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationsIDOrganisationVersionsGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationsIDOrganisationVersionsGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OrganisationVersionReadAll);
