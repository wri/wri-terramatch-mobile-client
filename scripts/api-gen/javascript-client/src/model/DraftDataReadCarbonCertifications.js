 ...
 * @version 1.0.0
 */
export class DraftDataReadCarbonCertifications {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DraftDataReadCarbonCertifications();
 ...
 * @member {String} type
 */
DraftDataReadCarbonCertifications.prototype.type = undefined;

/**
 * @member {String} other_value
 */
DraftDataReadCarbonCertifications.prototype.other_value = undefined;

/**
 * @member {String} link
 */
DraftDataReadCarbonCertifications.prototype.link = undefined;
