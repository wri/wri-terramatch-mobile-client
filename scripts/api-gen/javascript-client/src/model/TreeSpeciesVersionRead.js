...
import {TreeSpeciesRead} from './TreeSpeciesRead';
 ...
 * @version 1.0.0
 */
export class TreeSpeciesVersionRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TreeSpeciesVersionRead();
 ...
 * @member {Number} id
 */
TreeSpeciesVersionRead.prototype.id = undefined;

/**
 * @member {String} status
 */
TreeSpeciesVersionRead.prototype.status = undefined;

/**
 * @member {String} rejected_reason
 */
TreeSpeciesVersionRead.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
TreeSpeciesVersionRead.prototype.rejected_reason_body = undefined;

/**
 * @member {Number} approved_rejected_by
 */
TreeSpeciesVersionRead.prototype.approved_rejected_by = undefined;

/**
 * @member {Date} approved_rejected_at
 */
TreeSpeciesVersionRead.prototype.approved_rejected_at = undefined;

/**
 * @member {Date} created_at
 */
TreeSpeciesVersionRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
TreeSpeciesVersionRead.prototype.updated_at = undefined;

/**
 * @member {module:model/TreeSpeciesRead} data
 */
TreeSpeciesVersionRead.prototype.data = undefined;
