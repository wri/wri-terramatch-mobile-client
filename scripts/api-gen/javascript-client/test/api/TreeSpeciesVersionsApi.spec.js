    ...
    describe('TreeSpeciesVersionsApi', function() {
      describe('treeSpeciesIDTreeSpeciesVersionsGet', function() {
        it('should call treeSpeciesIDTreeSpeciesVersionsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for treeSpeciesIDTreeSpeciesVersionsGet call and complete the assertions
          /*
          var ID = 56;

          instance.treeSpeciesIDTreeSpeciesVersionsGet(ID).then(function(data) {
      ...
      describe('treeSpeciesVersionsIDApprovePatch', function() {
        it('should call treeSpeciesVersionsIDApprovePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for treeSpeciesVersionsIDApprovePatch call and complete the assertions
          /*
          var ID = 56;

          instance.treeSpeciesVersionsIDApprovePatch(ID).then(function(data) {
            // TODO: update response assertions
      ...
      describe('treeSpeciesVersionsIDDelete', function() {
        it('should call treeSpeciesVersionsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for treeSpeciesVersionsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.treeSpeciesVersionsIDDelete(ID).then(function(data) {
            // TODO: update response assertions
      ...
      describe('treeSpeciesVersionsIDGet', function() {
        it('should call treeSpeciesVersionsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for treeSpeciesVersionsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.treeSpeciesVersionsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('treeSpeciesVersionsIDRejectPatch', function() {
        it('should call treeSpeciesVersionsIDRejectPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for treeSpeciesVersionsIDRejectPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.TreeSpeciesVersionReject();
          Body.rejected_reason = "";
          Body.rejected_reason_body = "";

          instance.treeSpeciesVersionsIDRejectPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('treeSpeciesVersionsIDRevivePatch', function() {
        it('should call treeSpeciesVersionsIDRevivePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for treeSpeciesVersionsIDRevivePatch call and complete the assertions
          /*
          var ID = 56;

          instance.treeSpeciesVersionsIDRevivePatch(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
