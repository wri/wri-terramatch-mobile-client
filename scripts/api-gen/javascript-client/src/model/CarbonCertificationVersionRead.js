...
import {CarbonCertificationRead} from './CarbonCertificationRead';
 ...
 * @version 1.0.0
 */
export class CarbonCertificationVersionRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CarbonCertificationVersionRead();
 ...
 * @member {Number} id
 */
CarbonCertificationVersionRead.prototype.id = undefined;

/**
 * @member {String} status
 */
CarbonCertificationVersionRead.prototype.status = undefined;

/**
 * @member {String} rejected_reason
 */
CarbonCertificationVersionRead.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
CarbonCertificationVersionRead.prototype.rejected_reason_body = undefined;

/**
 * @member {Number} approved_rejected_by
 */
CarbonCertificationVersionRead.prototype.approved_rejected_by = undefined;

/**
 * @member {Date} approved_rejected_at
 */
CarbonCertificationVersionRead.prototype.approved_rejected_at = undefined;

/**
 * @member {Date} created_at
 */
CarbonCertificationVersionRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
CarbonCertificationVersionRead.prototype.updated_at = undefined;

/**
 * @member {module:model/CarbonCertificationRead} data
 */
CarbonCertificationVersionRead.prototype.data = undefined;
