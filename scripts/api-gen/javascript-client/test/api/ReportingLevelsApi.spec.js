    ...
    describe('ReportingLevelsApi', function() {
      describe('reportingLevelsGet', function() {
        it('should call reportingLevelsGet successfully', function(done) {
          // TODO: uncomment reportingLevelsGet call and complete the assertions
          /*

          instance.reportingLevelsGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.ReportingLevelReadAll);
