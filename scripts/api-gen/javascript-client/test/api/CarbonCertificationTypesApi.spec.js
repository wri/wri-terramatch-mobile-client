    ...
    describe('CarbonCertificationTypesApi', function() {
      describe('carbonCertificationTypesGet', function() {
        it('should call carbonCertificationTypesGet successfully', function(done) {
          // TODO: uncomment carbonCertificationTypesGet call and complete the assertions
          /*

          instance.carbonCertificationTypesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationTypeReadAll);
