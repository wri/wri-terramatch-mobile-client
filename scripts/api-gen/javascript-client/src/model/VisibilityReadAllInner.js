 ...
 * @version 1.0.0
 */
export class VisibilityReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new VisibilityReadAllInner();
 ...
 * @member {String} name
 */
VisibilityReadAllInner.prototype.name = undefined;

/**
 * @member {String} visibility
 */
VisibilityReadAllInner.prototype.visibility = undefined;
