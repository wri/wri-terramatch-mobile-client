...
import {ReportingFrequencyReadAllInner} from './ReportingFrequencyReadAllInner';
 ...
 * @version 1.0.0
 */
export class ReportingFrequencyReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ReportingFrequencyReadAll();
