    ...
    describe('RejectedReasonsApi', function() {
      describe('rejectedReasonsGet', function() {
        it('should call rejectedReasonsGet successfully', function(done) {
          // TODO: uncomment rejectedReasonsGet call and complete the assertions
          /*

          instance.rejectedReasonsGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.RejectedReasonReadAll);
