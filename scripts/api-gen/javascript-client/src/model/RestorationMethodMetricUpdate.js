 ...
 * @version 1.0.0
 */
export class RestorationMethodMetricUpdate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RestorationMethodMetricUpdate();
 ...
 */
RestorationMethodMetricUpdate.prototype.restoration_method = undefined;

/**
 * @member {Number} experience
 */
RestorationMethodMetricUpdate.prototype.experience = undefined;

/**
 * @member {Number} land_size
 */
RestorationMethodMetricUpdate.prototype.land_size = undefined;

/**
 * @member {Number} price_per_hectare
 */
RestorationMethodMetricUpdate.prototype.price_per_hectare = undefined;

/**
 * @member {Number} biomass_per_hectare
 */
RestorationMethodMetricUpdate.prototype.biomass_per_hectare = undefined;

/**
 * @member {Number} carbon_impact
 */
RestorationMethodMetricUpdate.prototype.carbon_impact = undefined;

/**
 * @member {Array.<String>} species_impacted
 */
RestorationMethodMetricUpdate.prototype.species_impacted = undefined;
