    ...
    describe('AdminsApi', function() {
      describe('adminsAcceptPost', function() {
        it('should call adminsAcceptPost successfully', function(done) {
          // TODO: uncomment, update parameter values for adminsAcceptPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.AdminAccept();
          Body.first_name = "";
          Body.last_name = "";
          Body.email_address = "";
          Body.password = "";
          ...
          instance.adminsAcceptPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.AdminRead);
      ...
      describe('adminsGet', function() {
        it('should call adminsGet successfully', function(done) {
          // TODO: uncomment adminsGet call and complete the assertions
          /*

          instance.adminsGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.AdminReadAll);
      ...
      describe('adminsIDGet', function() {
        it('should call adminsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for adminsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.adminsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.AdminRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('adminsIDPatch', function() {
        it('should call adminsIDPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for adminsIDPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.AdminUpdate();
          Body.first_name = "";
          Body.last_name = "";
          Body.email_address = "";
          Body.password = "";
          ...
          instance.adminsIDPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.AdminRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('adminsInvitePost', function() {
        it('should call adminsInvitePost successfully', function(done) {
          // TODO: uncomment, update parameter values for adminsInvitePost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.AdminInvite();
          Body.email_address = "";

          instance.adminsInvitePost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.AdminRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
