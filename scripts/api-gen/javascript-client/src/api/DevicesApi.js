...
export class DevicesApi {
    ...
    */
    ...
    /**
     * Read all devices
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DeviceReadAll} and HTTP response
     */
    devicesGetWithHttpInfo() {
      let postBody = null;
    ...
    /**
     * Read all devices
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DeviceReadAll}
     */
    devicesGet() {
      return this.devicesGetWithHttpInfo()
     ...
     */
    devicesIDDelete(ID) {
      return this.devicesIDDeleteWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * Read a device
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DeviceRead} and HTTP response
     */
    devicesIDGetWithHttpInfo(ID) {
      let postBody = null;
     ...
     * Read a device
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DeviceRead}
     */
    devicesIDGet(ID) {
      return this.devicesIDGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DeviceRead} and HTTP response
     */
    devicesIDPatchWithHttpInfo(ID, Body) {
      let postBody = Body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DeviceRead}
     */
    devicesIDPatch(ID, Body) {
      return this.devicesIDPatchWithHttpInfo(ID, Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    devicesPost(Body) {
      return this.devicesPostWithHttpInfo(Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
