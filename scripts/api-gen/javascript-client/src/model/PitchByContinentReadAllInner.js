 ...
 * @version 1.0.0
 */
export class PitchByContinentReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PitchByContinentReadAllInner();
 ...
 */
PitchByContinentReadAllInner.prototype.land_continent = undefined;

/**
 * @member {Number} count
 */
PitchByContinentReadAllInner.prototype.count = undefined;
