 ...
 * @version 1.0.0
 */
export class CompatibilityScoreCreate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CompatibilityScoreCreate();
 ...
 */
CompatibilityScoreCreate.prototype.initiator = undefined;

/**
 * @member {Number} offer_id
 */
CompatibilityScoreCreate.prototype.offer_id = undefined;

/**
 * @member {Number} pitch_id
 */
CompatibilityScoreCreate.prototype.pitch_id = undefined;
