...
* @version 1.0.0
*/
export class CompatibilityScoresApi {
    ...
    */
     ...
     */
    compatibilityScoresPostWithHttpInfo(Body) {
      let postBody = Body;
     ...
     */
    compatibilityScoresPost(Body) {
      return this.compatibilityScoresPostWithHttpInfo(Body)
