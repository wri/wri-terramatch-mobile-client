    ...
    describe('LandSizesApi', function() {
      describe('landSizesGet', function() {
        it('should call landSizesGet successfully', function(done) {
          // TODO: uncomment landSizesGet call and complete the assertions
          /*

          instance.landSizesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.LandSizeReadAll);
