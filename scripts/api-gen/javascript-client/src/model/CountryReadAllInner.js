 ...
 * @version 1.0.0
 */
export class CountryReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CountryReadAllInner();
 ...
 * @member {String} name
 */
CountryReadAllInner.prototype.name = undefined;

/**
 * @member {String} code
 */
CountryReadAllInner.prototype.code = undefined;

/**
 * @member {String} continent
 */
CountryReadAllInner.prototype.continent = undefined;
