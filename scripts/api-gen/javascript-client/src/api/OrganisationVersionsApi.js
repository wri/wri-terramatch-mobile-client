...
* @version 1.0.0
*/
export class OrganisationVersionsApi {
    ...
    */
     ...
     */
    organisationVersionsIDApprovePatchWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    organisationVersionsIDApprovePatch(ID) {
      return this.organisationVersionsIDApprovePatchWithHttpInfo(ID)
     ...
     */
    organisationVersionsIDDeleteWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    organisationVersionsIDDelete(ID) {
      return this.organisationVersionsIDDeleteWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationVersionRead} and HTTP response
     */
    organisationVersionsIDGetWithHttpInfo(ID) {
      let postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationVersionRead}
     */
    organisationVersionsIDGet(ID) {
      return this.organisationVersionsIDGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationVersionRead} and HTTP response
     */
    organisationVersionsIDRejectPatchWithHttpInfo(ID, Body) {
      let postBody = Body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationVersionRead}
     */
    organisationVersionsIDRejectPatch(ID, Body) {
      return this.organisationVersionsIDRejectPatchWithHttpInfo(ID, Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationVersionRead} and HTTP response
     */
    organisationVersionsIDRevivePatchWithHttpInfo(ID) {
      let postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationVersionRead}
     */
    organisationVersionsIDRevivePatch(ID) {
      return this.organisationVersionsIDRevivePatchWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationVersionReadAll} and HTTP response
     */
    organisationsIDOrganisationVersionsGetWithHttpInfo(ID) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = OrganisationVersionReadAll;
     ...
     * Read an organisation's organisation versions
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationVersionReadAll}
     */
    organisationsIDOrganisationVersionsGet(ID) {
      return this.organisationsIDOrganisationVersionsGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
