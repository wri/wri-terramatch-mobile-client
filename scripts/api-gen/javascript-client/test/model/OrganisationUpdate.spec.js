  ...
  describe('(package)', function() {
    describe('OrganisationUpdate', function() {
      ...
      it('should create an instance of OrganisationUpdate', function() {
        // TODO: update the code to test OrganisationUpdate
      ...
      it('should have the property address_1 (base name: "address_1")', function() {
        // TODO: update the code to test the property address_1
        expect(instance).to.have.property('address_1');
        // expect(instance.address_1).to.be(expectedValueLiteral);
      });

      it('should have the property address_2 (base name: "address_2")', function() {
        // TODO: update the code to test the property address_2
        expect(instance).to.have.property('address_2');
        // expect(instance.address_2).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property zip_code (base name: "zip_code")', function() {
        // TODO: update the code to test the property zip_code
        expect(instance).to.have.property('zip_code');
        // expect(instance.zip_code).to.be(expectedValueLiteral);
      });
