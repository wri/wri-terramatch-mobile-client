...
import {PitchByContinentReadAllInner} from './PitchByContinentReadAllInner';
 ...
 * @version 1.0.0
 */
export class PitchByContinentReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PitchByContinentReadAll();
