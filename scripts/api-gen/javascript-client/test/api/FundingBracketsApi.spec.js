    ...
    describe('FundingBracketsApi', function() {
      describe('fundingBracketsGet', function() {
        it('should call fundingBracketsGet successfully', function(done) {
          // TODO: uncomment fundingBracketsGet call and complete the assertions
          /*

          instance.fundingBracketsGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.FundingBracketReadAll);
