...
export class InterestsApi {
    ...
    */
     ...
     */
    interestsIDDeleteWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    interestsIDDelete(ID) {
      return this.interestsIDDeleteWithHttpInfo(ID)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/InterestReadAll} and HTTP response
     */
    interestsInitiatedGetWithHttpInfo() {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = InterestReadAll;
    ...
    /**
     * Read all interests initiated
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/InterestReadAll}
     */
    interestsInitiatedGet() {
      return this.interestsInitiatedGetWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/InterestRead} and HTTP response
     */
    interestsPostWithHttpInfo(Body) {
      let postBody = Body;
     ...
     * Create an interest
     * @param {module:model/InterestCreate} Body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/InterestRead}
     */
    interestsPost(Body) {
      return this.interestsPostWithHttpInfo(Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/InterestReadAll} and HTTP response
     */
    interestsReceivedGetWithHttpInfo() {
      let postBody = null;
    ...
    interestsReceivedGet() {
      return this.interestsReceivedGetWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
