 ...
 * @version 1.0.0
 */
export class CarbonCertificationCreate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CarbonCertificationCreate();
 ...
 */
CarbonCertificationCreate.prototype.pitch_id = undefined;

/**
 * @member {String} type
 */
CarbonCertificationCreate.prototype.type = undefined;

/**
 * @member {String} other_value
 */
CarbonCertificationCreate.prototype.other_value = undefined;

/**
 * @member {String} link
 */
CarbonCertificationCreate.prototype.link = undefined;
