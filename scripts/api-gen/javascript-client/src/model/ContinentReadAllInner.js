 ...
 * @version 1.0.0
 */
export class ContinentReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ContinentReadAllInner();
 ...
 * @member {String} name
 */
ContinentReadAllInner.prototype.name = undefined;

/**
 * @member {String} continent
 */
ContinentReadAllInner.prototype.continent = undefined;
