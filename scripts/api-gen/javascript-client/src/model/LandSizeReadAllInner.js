 ...
 * @version 1.0.0
 */
export class LandSizeReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new LandSizeReadAllInner();
 ...
 * @member {String} name
 */
LandSizeReadAllInner.prototype.name = undefined;

/**
 * @member {String} size
 */
LandSizeReadAllInner.prototype.size = undefined;
