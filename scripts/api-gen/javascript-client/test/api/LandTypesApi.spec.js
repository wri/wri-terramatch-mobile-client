    ...
    describe('LandTypesApi', function() {
      describe('landTypesGet', function() {
        it('should call landTypesGet successfully', function(done) {
          // TODO: uncomment landTypesGet call and complete the assertions
          /*

          instance.landTypesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.LandTypeReadAll);
