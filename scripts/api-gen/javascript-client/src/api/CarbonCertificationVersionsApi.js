...
* @version 1.0.0
*/
export class CarbonCertificationVersionsApi {
    ...
    */
     ...
     */
    carbonCertificationVersionsIDApprovePatchWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    carbonCertificationVersionsIDApprovePatch(ID) {
      return this.carbonCertificationVersionsIDApprovePatchWithHttpInfo(ID)
     ...
     */
    carbonCertificationVersionsIDDeleteWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    carbonCertificationVersionsIDDelete(ID) {
      return this.carbonCertificationVersionsIDDeleteWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CarbonCertificationVersionRead} and HTTP response
     */
    carbonCertificationVersionsIDGetWithHttpInfo(ID) {
      let postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CarbonCertificationVersionRead}
     */
    carbonCertificationVersionsIDGet(ID) {
      return this.carbonCertificationVersionsIDGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CarbonCertificationVersionRead} and HTTP response
     */
    carbonCertificationVersionsIDRejectPatchWithHttpInfo(ID, Body) {
      let postBody = Body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CarbonCertificationVersionRead}
     */
    carbonCertificationVersionsIDRejectPatch(ID, Body) {
      return this.carbonCertificationVersionsIDRejectPatchWithHttpInfo(ID, Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CarbonCertificationVersionRead} and HTTP response
     */
    carbonCertificationVersionsIDRevivePatchWithHttpInfo(ID) {
      let postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CarbonCertificationVersionRead}
     */
    carbonCertificationVersionsIDRevivePatch(ID) {
      return this.carbonCertificationVersionsIDRevivePatchWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    carbonCertificationsIDCarbonCertificationVersionsGetWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    carbonCertificationsIDCarbonCertificationVersionsGet(ID) {
      return this.carbonCertificationsIDCarbonCertificationVersionsGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
