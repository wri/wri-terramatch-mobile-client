    ...
    describe('DevicesApi', function() {
      describe('devicesGet', function() {
        it('should call devicesGet successfully', function(done) {
          // TODO: uncomment devicesGet call and complete the assertions
          /*

          instance.devicesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.DeviceReadAll);
      ...
      describe('devicesIDDelete', function() {
        it('should call devicesIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for devicesIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.devicesIDDelete(ID).then(function(data) {
            // TODO: update response assertions
      ...
      describe('devicesIDGet', function() {
        it('should call devicesIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for devicesIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.devicesIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.DeviceRead);
            ...
            expect(data.push_token).to.be.a('string');
            // expect(data.push_token).to.be("");
      ...
      describe('devicesIDPatch', function() {
        it('should call devicesIDPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for devicesIDPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.DeviceUpdate();
          Body.uuid = "";
          Body.push_token = "";

          instance.devicesIDPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.DeviceRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('devicesPost', function() {
        it('should call devicesPost successfully', function(done) {
          // TODO: uncomment, update parameter values for devicesPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.DeviceCreate();
          Body.os = "";
          Body.uuid = "";
          Body.push_token = "";

          instance.devicesPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.DeviceRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
