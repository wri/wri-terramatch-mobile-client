    ...
    describe('MatchesApi', function() {
      describe('matchesGet', function() {
        it('should call matchesGet successfully', function(done) {
          // TODO: uncomment matchesGet call and complete the assertions
          /*

          instance.matchesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.MatchReadAll);
      ...
      describe('matchesIDGet', function() {
        it('should call matchesIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for matchesIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.matchesIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.MatchRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
            expect(data.offer_id).to.be.a('number');
            // expect(data.offer_id).to.be(0);
            expect(data.offer_interest_id).to.be.a('number');
            // expect(data.offer_interest_id).to.be(0);
            {
              let dataCtr = data.offer_contacts;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(WriRestorationMarketplaceApi.MatchOfferContactRead);
                expect(data.id).to.be.a('number');
                // expect(data.id).to.be(0);
            ...
            expect(data.pitch_interest_id).to.be.a('number');
            // expect(data.pitch_interest_id).to.be(0);
            {
              let dataCtr = data.pitch_contacts;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(WriRestorationMarketplaceApi.MatchPitchContactRead);
                expect(data.id).to.be.a('number');
                // expect(data.id).to.be(0);
                expect(data.model).to.be.a('string');
                // expect(data.model).to.be("");
            ...
            expect(data.matched_at).to.be.a(Date);
            // expect(data.matched_at).to.be(new Date());
