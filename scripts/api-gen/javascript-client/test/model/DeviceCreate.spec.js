  ...
  describe('(package)', function() {
    describe('DeviceCreate', function() {
      ...
      it('should create an instance of DeviceCreate', function() {
        // TODO: update the code to test DeviceCreate
      ...
      it('should have the property push_token (base name: "push_token")', function() {
        // TODO: update the code to test the property push_token
        expect(instance).to.have.property('push_token');
        // expect(instance.push_token).to.be(expectedValueLiteral);
      });
