    ...
    describe('CarbonCertificationsApi', function() {
      describe('carbonCertificationsIDDelete', function() {
        it('should call carbonCertificationsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for carbonCertificationsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.carbonCertificationsIDDelete(ID).then(function(data) {
      ...
      describe('carbonCertificationsIDGet', function() {
        it('should call carbonCertificationsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for carbonCertificationsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.carbonCertificationsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationRead);
      ...
      describe('carbonCertificationsIDPatch', function() {
        it('should call carbonCertificationsIDPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for carbonCertificationsIDPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.CarbonCertificationUpdate();
          Body.type = "";
          Body.other_value = "";
          Body.link = "";

          instance.carbonCertificationsIDPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
      ...
      describe('carbonCertificationsPost', function() {
        it('should call carbonCertificationsPost successfully', function(done) {
          // TODO: uncomment, update parameter values for carbonCertificationsPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.CarbonCertificationCreate();
          Body.pitch_id = 0;
          Body.type = "";
          Body.other_value = "";
          Body.link = "";

          instance.carbonCertificationsPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('pitchesIDCarbonCertificationsGet', function() {
        it('should call pitchesIDCarbonCertificationsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchesIDCarbonCertificationsGet call and complete the assertions
          /*
          var ID = 56;

          instance.pitchesIDCarbonCertificationsGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationReadAll);
      ...
      describe('pitchesIDCarbonCertificationsInspectGet', function() {
        it('should call pitchesIDCarbonCertificationsInspectGet successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchesIDCarbonCertificationsInspectGet call and complete the assertions
          /*
          var ID = 56;

          instance.pitchesIDCarbonCertificationsInspectGet(ID).then(function(data) {
            // TODO: update response assertions
