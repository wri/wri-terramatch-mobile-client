 ...
 */
OfferCreate.prototype.land_types = undefined;

/**
 * @member {Array.<String>} land_ownerships
 */
OfferCreate.prototype.land_ownerships = undefined;

/**
 * @member {String} land_size
 */
OfferCreate.prototype.land_size = undefined;

/**
 * @member {String} land_continent
 */
OfferCreate.prototype.land_continent = undefined;

/**
 * @member {String} land_country
 */
OfferCreate.prototype.land_country = undefined;

/**
 * @member {Array.<String>} restoration_methods
 */
OfferCreate.prototype.restoration_methods = undefined;

/**
 * @member {Array.<String>} restoration_goals
 */
OfferCreate.prototype.restoration_goals = undefined;

/**
 * @member {Array.<String>} funding_sources
 */
OfferCreate.prototype.funding_sources = undefined;

/**
 * @member {Number} funding_amount
 */
OfferCreate.prototype.funding_amount = undefined;

/**
 * @member {String} funding_bracket
 */
OfferCreate.prototype.funding_bracket = undefined;

/**
 * @member {Number} price_per_tree
 */
OfferCreate.prototype.price_per_tree = undefined;

/**
 * @member {Boolean} long_term_engagement
 */
OfferCreate.prototype.long_term_engagement = undefined;

/**
 * @member {String} reporting_frequency
 */
OfferCreate.prototype.reporting_frequency = undefined;

/**
 * @member {String} reporting_level
 */
OfferCreate.prototype.reporting_level = undefined;

/**
 * @member {Array.<String>} sustainable_development_goals
 */
OfferCreate.prototype.sustainable_development_goals = undefined;

/**
 * @member {Number} cover_photo
 */
OfferCreate.prototype.cover_photo = undefined;

/**
 * @member {Number} video
 */
OfferCreate.prototype.video = undefined;
