 ...
 * @version 1.0.0
 */
export class CarbonCertificationTypeReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CarbonCertificationTypeReadAllInner();
 ...
 * @member {String} name
 */
CarbonCertificationTypeReadAllInner.prototype.name = undefined;

/**
 * @member {String} type
 */
CarbonCertificationTypeReadAllInner.prototype.type = undefined;
