    ...
    describe('LandOwnershipsApi', function() {
      describe('landOwnershipsGet', function() {
        it('should call landOwnershipsGet successfully', function(done) {
          // TODO: uncomment landOwnershipsGet call and complete the assertions
          /*

          instance.landOwnershipsGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.LandOwnershipReadAll);
