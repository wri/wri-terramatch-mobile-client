...
import {RestorationMethodMetricRead} from './RestorationMethodMetricRead';
 ...
 * @version 1.0.0
 */
export class RestorationMethodMetricVersionRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RestorationMethodMetricVersionRead();
 ...
 * @member {Number} id
 */
RestorationMethodMetricVersionRead.prototype.id = undefined;

/**
 * @member {String} status
 */
RestorationMethodMetricVersionRead.prototype.status = undefined;

/**
 * @member {String} rejected_reason
 */
RestorationMethodMetricVersionRead.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
RestorationMethodMetricVersionRead.prototype.rejected_reason_body = undefined;

/**
 * @member {Number} approved_rejected_by
 */
RestorationMethodMetricVersionRead.prototype.approved_rejected_by = undefined;

/**
 * @member {Date} approved_rejected_at
 */
RestorationMethodMetricVersionRead.prototype.approved_rejected_at = undefined;

/**
 * @member {Date} created_at
 */
RestorationMethodMetricVersionRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
RestorationMethodMetricVersionRead.prototype.updated_at = undefined;

/**
 * @member {module:model/RestorationMethodMetricRead} data
 */
RestorationMethodMetricVersionRead.prototype.data = undefined;
