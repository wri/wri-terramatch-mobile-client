...
import {CarbonCertificationTypeReadAllInner} from './CarbonCertificationTypeReadAllInner';
 ...
 * @version 1.0.0
 */
export class CarbonCertificationTypeReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CarbonCertificationTypeReadAll();
