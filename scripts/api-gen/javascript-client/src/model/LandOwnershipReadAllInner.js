 ...
 * @version 1.0.0
 */
export class LandOwnershipReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new LandOwnershipReadAllInner();
 ...
 * @member {String} name
 */
LandOwnershipReadAllInner.prototype.name = undefined;

/**
 * @member {String} ownership
 */
LandOwnershipReadAllInner.prototype.ownership = undefined;
