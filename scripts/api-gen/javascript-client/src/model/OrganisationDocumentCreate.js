 ...
 * @version 1.0.0
 */
export class OrganisationDocumentCreate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationDocumentCreate();
 ...
 * @member {String} name
 */
OrganisationDocumentCreate.prototype.name = undefined;

/**
 * @member {String} type
 */
OrganisationDocumentCreate.prototype.type = undefined;

/**
 * @member {Number} document
 */
OrganisationDocumentCreate.prototype.document = undefined;
