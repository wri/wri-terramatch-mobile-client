 ...
 * @member {Number} id
 */
TreeSpeciesRead.prototype.id = undefined;

/**
 * @member {Number} pitch_id
 */
TreeSpeciesRead.prototype.pitch_id = undefined;

/**
 * @member {String} name
 */
TreeSpeciesRead.prototype.name = undefined;

/**
 * @member {Boolean} is_native
 */
TreeSpeciesRead.prototype.is_native = undefined;

/**
 * @member {Number} count
 */
TreeSpeciesRead.prototype.count = undefined;

/**
 * @member {Number} price_to_plant
 */
TreeSpeciesRead.prototype.price_to_plant = undefined;

/**
 * @member {Number} price_to_maintain
 */
TreeSpeciesRead.prototype.price_to_maintain = undefined;

/**
 * @member {Number} saplings
 */
TreeSpeciesRead.prototype.saplings = undefined;

/**
 * @member {Number} site_prep
 */
TreeSpeciesRead.prototype.site_prep = undefined;

/**
 * @member {Number} survival_rate
 */
TreeSpeciesRead.prototype.survival_rate = undefined;

/**
 * @member {Boolean} produces_food
 */
TreeSpeciesRead.prototype.produces_food = undefined;

/**
 * @member {Boolean} produces_firewood
 */
TreeSpeciesRead.prototype.produces_firewood = undefined;

/**
 * @member {Boolean} produces_timber
 */
TreeSpeciesRead.prototype.produces_timber = undefined;

/**
 * @member {String} owner
 */
TreeSpeciesRead.prototype.owner = undefined;

/**
 * @member {String} season
 */
TreeSpeciesRead.prototype.season = undefined;

/**
 * @member {Date} created_at
 */
TreeSpeciesRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
TreeSpeciesRead.prototype.updated_at = undefined;
