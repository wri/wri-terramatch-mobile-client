  ...
  describe('(package)', function() {
    describe('MatchRead', function() {
      ...
      it('should create an instance of MatchRead', function() {
        // TODO: update the code to test MatchRead
      ...
      it('should have the property offer_interest_id (base name: "offer_interest_id")', function() {
        // TODO: update the code to test the property offer_interest_id
        expect(instance).to.have.property('offer_interest_id');
        // expect(instance.offer_interest_id).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property pitch_interest_id (base name: "pitch_interest_id")', function() {
        // TODO: update the code to test the property pitch_interest_id
        expect(instance).to.have.property('pitch_interest_id');
        // expect(instance.pitch_interest_id).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property matched_at (base name: "matched_at")', function() {
        // TODO: update the code to test the property matched_at
        expect(instance).to.have.property('matched_at');
        // expect(instance.matched_at).to.be(expectedValueLiteral);
      });
