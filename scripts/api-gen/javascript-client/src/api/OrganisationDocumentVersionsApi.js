...
* @version 1.0.0
*/
export class OrganisationDocumentVersionsApi {
    ...
    */
     ...
     */
    organisationDocumentVersionsIDApprovePatchWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    organisationDocumentVersionsIDApprovePatch(ID) {
      return this.organisationDocumentVersionsIDApprovePatchWithHttpInfo(ID)
     ...
     */
    organisationDocumentVersionsIDDeleteWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    organisationDocumentVersionsIDDelete(ID) {
      return this.organisationDocumentVersionsIDDeleteWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationDocumentVersionRead} and HTTP response
     */
    organisationDocumentVersionsIDGetWithHttpInfo(ID) {
      let postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationDocumentVersionRead}
     */
    organisationDocumentVersionsIDGet(ID) {
      return this.organisationDocumentVersionsIDGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationDocumentVersionRead} and HTTP response
     */
    organisationDocumentVersionsIDRejectPatchWithHttpInfo(ID, Body) {
      let postBody = Body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationDocumentVersionRead}
     */
    organisationDocumentVersionsIDRejectPatch(ID, Body) {
      return this.organisationDocumentVersionsIDRejectPatchWithHttpInfo(ID, Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganisationDocumentVersionRead} and HTTP response
     */
    organisationDocumentVersionsIDRevivePatchWithHttpInfo(ID) {
      let postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganisationDocumentVersionRead}
     */
    organisationDocumentVersionsIDRevivePatch(ID) {
      return this.organisationDocumentVersionsIDRevivePatchWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    organisationDocumentsIDOrganisationDocumentVersionsGetWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    organisationDocumentsIDOrganisationDocumentVersionsGet(ID) {
      return this.organisationDocumentsIDOrganisationDocumentVersionsGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
