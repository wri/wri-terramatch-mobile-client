...
export class TeamMembersApi {
    ...
    */
     ...
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/MaskedTeamMemberReadAll} and HTTP response
     */
    organisationsIDTeamMembersGetWithHttpInfo(ID) {
      let postBody = null;
      ...
      let returnType = MaskedTeamMemberReadAll;
     ...
     * Read an organisation's team members
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/MaskedTeamMemberReadAll}
     */
    organisationsIDTeamMembersGet(ID) {
      return this.organisationsIDTeamMembersGetWithHttpInfo(ID)
     ...
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TeamMemberReadAll} and HTTP response
     */
    organisationsIDTeamMembersInspectGetWithHttpInfo(ID) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TeamMemberReadAll;
     ...
     * Inspect an organisation's team members
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TeamMemberReadAll}
     */
    organisationsIDTeamMembersInspectGet(ID) {
      return this.organisationsIDTeamMembersInspectGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    teamMembersIDDeleteWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    teamMembersIDDelete(ID) {
      return this.teamMembersIDDeleteWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * Read a team member
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TeamMemberRead} and HTTP response
     */
    teamMembersIDGetWithHttpInfo(ID) {
      let postBody = null;
     ...
     * Read a team member
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TeamMemberRead}
     */
    teamMembersIDGet(ID) {
      return this.teamMembersIDGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TeamMemberRead} and HTTP response
     */
    teamMembersIDPatchWithHttpInfo(ID, Body) {
      let postBody = Body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TeamMemberRead}
     */
    teamMembersIDPatch(ID, Body) {
      return this.teamMembersIDPatchWithHttpInfo(ID, Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TeamMemberRead} and HTTP response
     */
    teamMembersPostWithHttpInfo(Body) {
      let postBody = Body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TeamMemberRead}
     */
    teamMembersPost(Body) {
      return this.teamMembersPostWithHttpInfo(Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
