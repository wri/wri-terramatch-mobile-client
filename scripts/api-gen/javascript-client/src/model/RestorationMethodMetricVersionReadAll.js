...
import {RestorationMethodMetricVersionRead} from './RestorationMethodMetricVersionRead';
 ...
 * @version 1.0.0
 */
export class RestorationMethodMetricVersionReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RestorationMethodMetricVersionReadAll();
