    ...
    describe('UsersApi', function() {
      describe('organisationsIDUsersGet', function() {
        it('should call organisationsIDUsersGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationsIDUsersGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationsIDUsersGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.MaskedUserReadAll);
      ...
      describe('organisationsIDUsersInspectGet', function() {
        it('should call organisationsIDUsersInspectGet successfully', function(done) {
          // TODO: uncomment, update parameter values for organisationsIDUsersInspectGet call and complete the assertions
          /*
          var ID = 56;

          instance.organisationsIDUsersInspectGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.UserReadAll);
      ...
      describe('usersAcceptPost', function() {
        it('should call usersAcceptPost successfully', function(done) {
          // TODO: uncomment, update parameter values for usersAcceptPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.UserAccept();
          Body.first_name = "";
          Body.last_name = "";
          Body.email_address = "";
          Body.password = "";
          ...
          instance.usersAcceptPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.UserRead);
            ...
            // expect(data.first_name).to.be("");
            expect(data.last_name).to.be.a('string');
            // expect(data.last_name).to.be("");
            expect(data.email_address).to.be.a('string');
            // expect(data.email_address).to.be("");
            expect(data.email_address_verified_at).to.be.a(Date);
            // expect(data.email_address_verified_at).to.be(new Date());
            expect(data.role).to.be.a('string');
            // expect(data.role).to.be("");
            expect(data.last_logged_in_at).to.be.a(Date);
            // expect(data.last_logged_in_at).to.be(new Date());
            expect(data.job_role).to.be.a('string');
            // expect(data.job_role).to.be("");
      ...
      describe('usersIDGet', function() {
        it('should call usersIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for usersIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.usersIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.UserRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('usersIDPatch', function() {
        it('should call usersIDPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for usersIDPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.UserUpdate();
          Body.first_name = "";
          Body.last_name = "";
          Body.email_address = "";
          Body.password = "";
          ...
          instance.usersIDPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.UserRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('usersInvitePost', function() {
        it('should call usersInvitePost successfully', function(done) {
          // TODO: uncomment, update parameter values for usersInvitePost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.UserInvite();
          Body.email_address = "";

          instance.usersInvitePost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.UserRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('usersPost', function() {
        it('should call usersPost successfully', function(done) {
          ...
          /*
          var Body = new WriRestorationMarketplaceApi.UserCreate();
          Body.first_name = "";
          Body.last_name = "";
          Body.email_address = "";
          Body.password = "";
          ...
          instance.usersPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.UserRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
