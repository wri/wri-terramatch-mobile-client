 ...
 */
OfferUpdate.prototype.land_types = undefined;

/**
 * @member {Array.<String>} land_ownerships
 */
OfferUpdate.prototype.land_ownerships = undefined;

/**
 * @member {String} land_size
 */
OfferUpdate.prototype.land_size = undefined;

/**
 * @member {String} land_continent
 */
OfferUpdate.prototype.land_continent = undefined;

/**
 * @member {String} land_country
 */
OfferUpdate.prototype.land_country = undefined;

/**
 * @member {Array.<String>} restoration_methods
 */
OfferUpdate.prototype.restoration_methods = undefined;

/**
 * @member {Array.<String>} restoration_goals
 */
OfferUpdate.prototype.restoration_goals = undefined;

/**
 * @member {Array.<String>} funding_sources
 */
OfferUpdate.prototype.funding_sources = undefined;

/**
 * @member {Number} funding_amount
 */
OfferUpdate.prototype.funding_amount = undefined;

/**
 * @member {String} funding_bracket
 */
OfferUpdate.prototype.funding_bracket = undefined;

/**
 * @member {Number} price_per_tree
 */
OfferUpdate.prototype.price_per_tree = undefined;

/**
 * @member {Boolean} long_term_engagement
 */
OfferUpdate.prototype.long_term_engagement = undefined;

/**
 * @member {String} reporting_frequency
 */
OfferUpdate.prototype.reporting_frequency = undefined;

/**
 * @member {String} reporting_level
 */
OfferUpdate.prototype.reporting_level = undefined;

/**
 * @member {Array.<String>} sustainable_development_goals
 */
OfferUpdate.prototype.sustainable_development_goals = undefined;

/**
 * @member {Number} cover_photo
 */
OfferUpdate.prototype.cover_photo = undefined;

/**
 * @member {Number} video
 */
OfferUpdate.prototype.video = undefined;
