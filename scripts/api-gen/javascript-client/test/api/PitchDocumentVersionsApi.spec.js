    ...
    describe('PitchDocumentVersionsApi', function() {
      describe('pitchDocumentVersionsIDApprovePatch', function() {
        it('should call pitchDocumentVersionsIDApprovePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchDocumentVersionsIDApprovePatch call and complete the assertions
          /*
          var ID = 56;

          instance.pitchDocumentVersionsIDApprovePatch(ID).then(function(data) {
      ...
      describe('pitchDocumentVersionsIDDelete', function() {
        it('should call pitchDocumentVersionsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchDocumentVersionsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.pitchDocumentVersionsIDDelete(ID).then(function(data) {
            // TODO: update response assertions
      ...
      describe('pitchDocumentVersionsIDGet', function() {
        it('should call pitchDocumentVersionsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchDocumentVersionsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.pitchDocumentVersionsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.PitchDocumentVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('pitchDocumentVersionsIDRejectPatch', function() {
        it('should call pitchDocumentVersionsIDRejectPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchDocumentVersionsIDRejectPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.PitchDocumentVersionReject();
          Body.rejected_reason = "";
          Body.rejected_reason_body = "";

          instance.pitchDocumentVersionsIDRejectPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.PitchDocumentVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('pitchDocumentVersionsIDRevivePatch', function() {
        it('should call pitchDocumentVersionsIDRevivePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchDocumentVersionsIDRevivePatch call and complete the assertions
          /*
          var ID = 56;

          instance.pitchDocumentVersionsIDRevivePatch(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.PitchDocumentVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('pitchDocumentsIDPitchDocumentVersionsGet', function() {
        it('should call pitchDocumentsIDPitchDocumentVersionsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchDocumentsIDPitchDocumentVersionsGet call and complete the assertions
          /*
          var ID = 56;

          instance.pitchDocumentsIDPitchDocumentVersionsGet(ID).then(function(data) {
            // TODO: update response assertions
