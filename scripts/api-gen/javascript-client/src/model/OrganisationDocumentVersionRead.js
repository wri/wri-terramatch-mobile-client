...
import {OrganisationDocumentRead} from './OrganisationDocumentRead';
 ...
 * @version 1.0.0
 */
export class OrganisationDocumentVersionRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationDocumentVersionRead();
 ...
 * @member {Number} id
 */
OrganisationDocumentVersionRead.prototype.id = undefined;

/**
 * @member {String} status
 */
OrganisationDocumentVersionRead.prototype.status = undefined;

/**
 * @member {String} rejected_reason
 */
OrganisationDocumentVersionRead.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
OrganisationDocumentVersionRead.prototype.rejected_reason_body = undefined;

/**
 * @member {Number} approved_rejected_by
 */
OrganisationDocumentVersionRead.prototype.approved_rejected_by = undefined;

/**
 * @member {Date} approved_rejected_at
 */
OrganisationDocumentVersionRead.prototype.approved_rejected_at = undefined;

/**
 * @member {Date} created_at
 */
OrganisationDocumentVersionRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
OrganisationDocumentVersionRead.prototype.updated_at = undefined;

/**
 * @member {module:model/OrganisationDocumentRead} data
 */
OrganisationDocumentVersionRead.prototype.data = undefined;
