 ...
 * @version 1.0.0
 */
export class DraftDataReadRestorationMethodMetrics {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DraftDataReadRestorationMethodMetrics();
 ...
 */
DraftDataReadRestorationMethodMetrics.prototype.restoration_method = undefined;

/**
 * @member {Number} experience
 */
DraftDataReadRestorationMethodMetrics.prototype.experience = undefined;

/**
 * @member {Number} land_size
 */
DraftDataReadRestorationMethodMetrics.prototype.land_size = undefined;

/**
 * @member {Number} price_per_hectare
 */
DraftDataReadRestorationMethodMetrics.prototype.price_per_hectare = undefined;

/**
 * @member {Number} biomass_per_hectare
 */
DraftDataReadRestorationMethodMetrics.prototype.biomass_per_hectare = undefined;

/**
 * @member {Number} carbon_impact
 */
DraftDataReadRestorationMethodMetrics.prototype.carbon_impact = undefined;

/**
 * @member {Array.<String>} species_impacted
 */
DraftDataReadRestorationMethodMetrics.prototype.species_impacted = undefined;
