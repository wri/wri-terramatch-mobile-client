...
export class NotificationsApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/NotificationReadAll} and HTTP response
     */
    notificationsGetWithHttpInfo() {
      let postBody = null;
      ...
      let returnType = NotificationReadAll;
    ...
    /**
     * Read all notifications
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/NotificationReadAll}
     */
    notificationsGet() {
      return this.notificationsGetWithHttpInfo()
     ...
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/NotificationRead} and HTTP response
     */
    notificationsIDMarkPatchWithHttpInfo(ID) {
      let postBody = null;
     ...
     * Mark a notification as read
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/NotificationRead}
     */
    notificationsIDMarkPatch(ID) {
      return this.notificationsIDMarkPatchWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
