...
* @version 1.0.0
*/
export class ElevatorVideosApi {
    ...
    */
     ...
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ElevatorVideoRead} and HTTP response
     */
    elevatorVideosIDGetWithHttpInfo(ID) {
      let postBody = null;
      ...
      let returnType = ElevatorVideoRead;
     ...
     * Read an elevator video
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ElevatorVideoRead}
     */
    elevatorVideosIDGet(ID) {
      return this.elevatorVideosIDGetWithHttpInfo(ID)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ElevatorVideoRead} and HTTP response
     */
    elevatorVideosPostWithHttpInfo(Body) {
      let postBody = Body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ElevatorVideoRead}
     */
    elevatorVideosPost(Body) {
      return this.elevatorVideosPostWithHttpInfo(Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
