    ...
    describe('CountriesApi', function() {
      describe('countriesGet', function() {
        it('should call countriesGet successfully', function(done) {
          // TODO: uncomment countriesGet call and complete the assertions
          /*

          instance.countriesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.CountryReadAll);
