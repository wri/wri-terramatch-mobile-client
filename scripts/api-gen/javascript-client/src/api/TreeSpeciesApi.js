...
export class TreeSpeciesApi {
    ...
    */
     ...
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TreeSpeciesReadAll} and HTTP response
     */
    pitchesIDTreeSpeciesGetWithHttpInfo(ID) {
      let postBody = null;
      ...
      let returnType = TreeSpeciesReadAll;
     ...
     * Read a pitch's tree species
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TreeSpeciesReadAll}
     */
    pitchesIDTreeSpeciesGet(ID) {
      return this.pitchesIDTreeSpeciesGetWithHttpInfo(ID)
     ...
     */
    pitchesIDTreeSpeciesInspectGetWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    pitchesIDTreeSpeciesInspectGet(ID) {
      return this.pitchesIDTreeSpeciesInspectGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    treeSpeciesIDDeleteWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    treeSpeciesIDDelete(ID) {
      return this.treeSpeciesIDDeleteWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * Read a tree species
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TreeSpeciesRead} and HTTP response
     */
    treeSpeciesIDGetWithHttpInfo(ID) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TreeSpeciesRead;
     ...
     * Read a tree species
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TreeSpeciesRead}
     */
    treeSpeciesIDGet(ID) {
      return this.treeSpeciesIDGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    treeSpeciesIDPatchWithHttpInfo(ID, Body) {
      let postBody = Body;
     ...
     */
    treeSpeciesIDPatch(ID, Body) {
      return this.treeSpeciesIDPatchWithHttpInfo(ID, Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TreeSpeciesVersionRead} and HTTP response
     */
    treeSpeciesPostWithHttpInfo(Body) {
      let postBody = Body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TreeSpeciesVersionRead}
     */
    treeSpeciesPost(Body) {
      return this.treeSpeciesPostWithHttpInfo(Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
