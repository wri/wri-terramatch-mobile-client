 ...
 * @version 1.0.0
 */
export class RevenueDriverReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RevenueDriverReadAllInner();
 ...
 * @member {String} name
 */
RevenueDriverReadAllInner.prototype.name = undefined;

/**
 * @member {String} driver
 */
RevenueDriverReadAllInner.prototype.driver = undefined;
