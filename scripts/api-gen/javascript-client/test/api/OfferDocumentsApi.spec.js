    ...
    describe('OfferDocumentsApi', function() {
      describe('offerDocumentsIDDelete', function() {
        it('should call offerDocumentsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for offerDocumentsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.offerDocumentsIDDelete(ID).then(function(data) {
      ...
      describe('offerDocumentsIDGet', function() {
        it('should call offerDocumentsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for offerDocumentsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.offerDocumentsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OfferDocumentRead);
      ...
      describe('offerDocumentsIDPatch', function() {
        it('should call offerDocumentsIDPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for offerDocumentsIDPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.OfferDocumentUpdate();
          Body.name = "";
          Body.type = "";
          Body.document = 0;

          instance.offerDocumentsIDPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OfferDocumentRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('offerDocumentsPost', function() {
        it('should call offerDocumentsPost successfully', function(done) {
          // TODO: uncomment, update parameter values for offerDocumentsPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.OfferDocumentCreate();
          Body.offer_id = 0;
          Body.name = "";
          Body.type = "";
          Body.document = 0;

          instance.offerDocumentsPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OfferDocumentRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('offersIDOfferDocumentsGet', function() {
        it('should call offersIDOfferDocumentsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for offersIDOfferDocumentsGet call and complete the assertions
          /*
          var ID = 56;

          instance.offersIDOfferDocumentsGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OfferDocumentReadAll);
