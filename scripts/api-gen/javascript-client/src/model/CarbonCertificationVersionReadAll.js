...
import {CarbonCertificationVersionRead} from './CarbonCertificationVersionRead';
 ...
 * @version 1.0.0
 */
export class CarbonCertificationVersionReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CarbonCertificationVersionReadAll();
