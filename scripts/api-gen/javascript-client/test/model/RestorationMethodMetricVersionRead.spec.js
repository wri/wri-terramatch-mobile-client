  ...
  describe('(package)', function() {
    describe('RestorationMethodMetricVersionRead', function() {
      ...
      it('should create an instance of RestorationMethodMetricVersionRead', function() {
        // TODO: update the code to test RestorationMethodMetricVersionRead
      ...
      it('should have the property rejected_reason (base name: "rejected_reason")', function() {
        // TODO: update the code to test the property rejected_reason
        expect(instance).to.have.property('rejected_reason');
        // expect(instance.rejected_reason).to.be(expectedValueLiteral);
      });

      it('should have the property rejected_reason_body (base name: "rejected_reason_body")', function() {
        // TODO: update the code to test the property rejected_reason_body
        expect(instance).to.have.property('rejected_reason_body');
        // expect(instance.rejected_reason_body).to.be(expectedValueLiteral);
      });

      it('should have the property approved_rejected_by (base name: "approved_rejected_by")', function() {
        // TODO: update the code to test the property approved_rejected_by
        expect(instance).to.have.property('approved_rejected_by');
        // expect(instance.approved_rejected_by).to.be(expectedValueLiteral);
      });

      it('should have the property approved_rejected_at (base name: "approved_rejected_at")', function() {
        // TODO: update the code to test the property approved_rejected_at
        expect(instance).to.have.property('approved_rejected_at');
        // expect(instance.approved_rejected_at).to.be(expectedValueLiteral);
      });
