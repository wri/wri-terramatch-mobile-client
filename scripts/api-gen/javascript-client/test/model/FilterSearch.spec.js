  ...
  describe('(package)', function() {
    describe('FilterSearch', function() {
      ...
      it('should create an instance of FilterSearch', function() {
        // TODO: update the code to test FilterSearch
      ...
      it('should have the property sortAttribute (base name: "sortAttribute")', function() {
        // TODO: update the code to test the property sortAttribute
        expect(instance).to.have.property('sortAttribute');
        // expect(instance.sortAttribute).to.be(expectedValueLiteral);
      });
