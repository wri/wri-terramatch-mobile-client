...
export class OfferContactsApi {
    ...
    */
     ...
     */
    offerContactsIDDeleteWithHttpInfo(ID) {
      let postBody = null;
     ...
     */
    offerContactsIDDelete(ID) {
      return this.offerContactsIDDeleteWithHttpInfo(ID)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OfferContactRead} and HTTP response
     */
    offerContactsPostWithHttpInfo(Body) {
      let postBody = Body;
      ...
      let accepts = ['application/json'];
      let returnType = OfferContactRead;
     ...
     * Create an offer contact
     * @param {module:model/OfferContactCreate} Body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OfferContactRead}
     */
    offerContactsPost(Body) {
      return this.offerContactsPostWithHttpInfo(Body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OfferContactReadAll} and HTTP response
     */
    offersIDOfferContactsGetWithHttpInfo(ID) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = OfferContactReadAll;
     ...
     * Read an offer's offer contacts
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OfferContactReadAll}
     */
    offersIDOfferContactsGet(ID) {
      return this.offersIDOfferContactsGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
