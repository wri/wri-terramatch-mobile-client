    ...
    describe('OfferContactsApi', function() {
      describe('offerContactsIDDelete', function() {
        it('should call offerContactsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for offerContactsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.offerContactsIDDelete(ID).then(function(data) {
      ...
      describe('offerContactsPost', function() {
        it('should call offerContactsPost successfully', function(done) {
          // TODO: uncomment, update parameter values for offerContactsPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.OfferContactCreate();
          Body.offer_id = 0;
          Body.user_id = 0;
          Body.team_member_id = 0;

          instance.offerContactsPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OfferContactRead);
      ...
      describe('offersIDOfferContactsGet', function() {
        it('should call offersIDOfferContactsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for offersIDOfferContactsGet call and complete the assertions
          /*
          var ID = 56;

          instance.offersIDOfferContactsGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.OfferContactReadAll);
