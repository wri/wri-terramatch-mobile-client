    ...
    describe('ReportingFrequenciesApi', function() {
      describe('reportingFrequenciesGet', function() {
        it('should call reportingFrequenciesGet successfully', function(done) {
          // TODO: uncomment reportingFrequenciesGet call and complete the assertions
          /*

          instance.reportingFrequenciesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.ReportingFrequencyReadAll);
