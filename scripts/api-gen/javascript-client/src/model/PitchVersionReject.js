 ...
 * @version 1.0.0
 */
export class PitchVersionReject {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PitchVersionReject();
 ...
 */
PitchVersionReject.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
PitchVersionReject.prototype.rejected_reason_body = undefined;
