...
import {RestorationMethodReadAllInner} from './RestorationMethodReadAllInner';
 ...
 * @version 1.0.0
 */
export class RestorationMethodReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RestorationMethodReadAll();
