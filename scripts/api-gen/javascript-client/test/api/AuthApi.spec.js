    ...
    describe('AuthApi', function() {
      describe('authChangePatch', function() {
        it('should call authChangePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for authChangePatch call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.AuthChange();
          Body.token = "";
          Body.password = "";

          instance.authChangePatch(Body).then(function(data) {
      ...
      describe('authLoginPost', function() {
        it('should call authLoginPost successfully', function(done) {
          ...
          /*
          var Body = new WriRestorationMarketplaceApi.AuthLogIn();
          Body.email_address = "";
          Body.password = "";

          instance.authLoginPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.TokenRead);
      ...
      describe('authLogoutGet', function() {
        it('should call authLogoutGet successfully', function(done) {
          // TODO: uncomment authLogoutGet call and complete the assertions
          /*

          instance.authLogoutGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.Empty);
      ...
      describe('authMeGet', function() {
        it('should call authMeGet successfully', function(done) {
          // TODO: uncomment authMeGet call and complete the assertions
          /*

          instance.authMeGet().then(function(data) {
            // TODO: update response assertions
      ...
      describe('authRefreshGet', function() {
        it('should call authRefreshGet successfully', function(done) {
          // TODO: uncomment authRefreshGet call and complete the assertions
          /*

          instance.authRefreshGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.TokenRead);
            expect(data.token).to.be.a('string');
            // expect(data.token).to.be("");
      ...
      describe('authResendGet', function() {
        it('should call authResendGet successfully', function(done) {
          // TODO: uncomment authResendGet call and complete the assertions
          /*

          instance.authResendGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.Empty);
      ...
      describe('authResetPost', function() {
        it('should call authResetPost successfully', function(done) {
          // TODO: uncomment, update parameter values for authResetPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.AuthReset();
          Body.email_address = "";

          instance.authResetPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.Empty);
      ...
      describe('authVerifyPatch', function() {
        it('should call authVerifyPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for authVerifyPatch call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.AuthVerify();
          Body.token = "";

          instance.authVerifyPatch(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.Empty);
