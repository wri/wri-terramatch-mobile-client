 ...
 * @version 1.0.0
 */
export class OrganisationDocumentUpdate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationDocumentUpdate();
 ...
 * @member {String} name
 */
OrganisationDocumentUpdate.prototype.name = undefined;

/**
 * @member {String} type
 */
OrganisationDocumentUpdate.prototype.type = undefined;

/**
 * @member {Number} document
 */
OrganisationDocumentUpdate.prototype.document = undefined;
