    ...
    describe('DocumentTypesApi', function() {
      describe('documentTypesGet', function() {
        it('should call documentTypesGet successfully', function(done) {
          // TODO: uncomment documentTypesGet call and complete the assertions
          /*

          instance.documentTypesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.DocumentTypeReadAll);
