    ...
    describe('NotificationsApi', function() {
      describe('notificationsGet', function() {
        it('should call notificationsGet successfully', function(done) {
          // TODO: uncomment notificationsGet call and complete the assertions
          /*

          instance.notificationsGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.NotificationReadAll);
      ...
      describe('notificationsIDMarkPatch', function() {
        it('should call notificationsIDMarkPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for notificationsIDMarkPatch call and complete the assertions
          /*
          var ID = 56;

          instance.notificationsIDMarkPatch(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.NotificationRead);
            ...
            expect(data.referenced_model).to.be.a('string');
            // expect(data.referenced_model).to.be("");
            expect(data.referenced_model_id).to.be.a('number');
            // expect(data.referenced_model_id).to.be(0);
            expect(data.unread).to.be.a('boolean');
