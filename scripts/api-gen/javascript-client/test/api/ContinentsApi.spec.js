    ...
    describe('ContinentsApi', function() {
      describe('continentsGet', function() {
        it('should call continentsGet successfully', function(done) {
          // TODO: uncomment continentsGet call and complete the assertions
          /*

          instance.continentsGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.ContinentReadAll);
