...
let apiInstance = new WriRestorationMarketplaceApi.DevicesApi();
apiInstance.devicesGet().then((data) => {
...
apiInstance.devicesIDDelete(ID).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.devicesIDGet(ID).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let Body = new WriRestorationMarketplaceApi.DeviceUpdate(); // DeviceUpdate | 

apiInstance.devicesIDPatch(ID, Body).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let Body = new WriRestorationMarketplaceApi.DeviceCreate(); // DeviceCreate | 

apiInstance.devicesPost(Body).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
