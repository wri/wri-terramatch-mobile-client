...
import {OrganisationDocumentVersionRead} from './OrganisationDocumentVersionRead';
 ...
 * @version 1.0.0
 */
export class OrganisationDocumentVersionReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationDocumentVersionReadAll();
