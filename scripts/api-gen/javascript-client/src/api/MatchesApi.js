...
export class MatchesApi {
    ...
    */
     ...
     */
    matchesGet() {
      return this.matchesGetWithHttpInfo()
     ...
     * Read a match
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/MatchRead} and HTTP response
     */
    matchesIDGetWithHttpInfo(ID) {
      let postBody = null;
     ...
     * Read a match
     * @param {Number} ID 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/MatchRead}
     */
    matchesIDGet(ID) {
      return this.matchesIDGetWithHttpInfo(ID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
