 ...
 * @version 1.0.0
 */
export class ReportingFrequencyReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ReportingFrequencyReadAllInner();
 ...
 * @member {String} name
 */
ReportingFrequencyReadAllInner.prototype.name = undefined;

/**
 * @member {String} frequency
 */
ReportingFrequencyReadAllInner.prototype.frequency = undefined;
