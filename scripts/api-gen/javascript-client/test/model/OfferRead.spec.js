  ...
  describe('(package)', function() {
    describe('OfferRead', function() {
      ...
      it('should create an instance of OfferRead', function() {
        // TODO: update the code to test OfferRead
      ...
      it('should have the property compatibility_score (base name: "compatibility_score")', function() {
        // TODO: update the code to test the property compatibility_score
        expect(instance).to.have.property('compatibility_score');
        // expect(instance.compatibility_score).to.be(expectedValueLiteral);
      });
