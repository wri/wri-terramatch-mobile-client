...
import {OrganisationRead} from './OrganisationRead';
 ...
 * @version 1.0.0
 */
export class OrganisationVersionRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationVersionRead();
 ...
 * @member {Number} id
 */
OrganisationVersionRead.prototype.id = undefined;

/**
 * @member {String} status
 */
OrganisationVersionRead.prototype.status = undefined;

/**
 * @member {String} rejected_reason
 */
OrganisationVersionRead.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
OrganisationVersionRead.prototype.rejected_reason_body = undefined;

/**
 * @member {Number} approved_rejected_by
 */
OrganisationVersionRead.prototype.approved_rejected_by = undefined;

/**
 * @member {Date} approved_rejected_at
 */
OrganisationVersionRead.prototype.approved_rejected_at = undefined;

/**
 * @member {Date} created_at
 */
OrganisationVersionRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
OrganisationVersionRead.prototype.updated_at = undefined;

/**
 * @member {module:model/OrganisationRead} data
 */
OrganisationVersionRead.prototype.data = undefined;
