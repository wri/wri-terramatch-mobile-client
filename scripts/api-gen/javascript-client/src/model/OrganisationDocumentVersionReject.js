 ...
 * @version 1.0.0
 */
export class OrganisationDocumentVersionReject {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationDocumentVersionReject();
 ...
 */
OrganisationDocumentVersionReject.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
OrganisationDocumentVersionReject.prototype.rejected_reason_body = undefined;
