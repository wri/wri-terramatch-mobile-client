...
* @version 1.0.0
*/
export class LandOwnershipsApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/LandOwnershipReadAll} and HTTP response
     */
    landOwnershipsGetWithHttpInfo() {
      let postBody = null;
      ...
      let returnType = LandOwnershipReadAll;
    ...
    /**
     * Read all land ownerships
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/LandOwnershipReadAll}
     */
    landOwnershipsGet() {
      return this.landOwnershipsGetWithHttpInfo()
