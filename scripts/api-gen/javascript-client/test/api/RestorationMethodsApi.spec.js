    ...
    describe('RestorationMethodsApi', function() {
      describe('restorationMethodsGet', function() {
        it('should call restorationMethodsGet successfully', function(done) {
          // TODO: uncomment restorationMethodsGet call and complete the assertions
          /*

          instance.restorationMethodsGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.RestorationMethodReadAll);
