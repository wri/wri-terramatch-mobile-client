    ...
    describe('RevenueDriversApi', function() {
      describe('revenueDriversGet', function() {
        it('should call revenueDriversGet successfully', function(done) {
          // TODO: uncomment revenueDriversGet call and complete the assertions
          /*

          instance.revenueDriversGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.RevenueDriverReadAll);
