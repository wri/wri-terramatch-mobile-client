 ...
 * @version 1.0.0
 */
export class OrganisationVersionReject {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationVersionReject();
 ...
 */
OrganisationVersionReject.prototype.rejected_reason = undefined;

/**
 * @member {String} rejected_reason_body
 */
OrganisationVersionReject.prototype.rejected_reason_body = undefined;
