    ...
    describe('FundingSourcesApi', function() {
      describe('fundingSourcesGet', function() {
        it('should call fundingSourcesGet successfully', function(done) {
          // TODO: uncomment fundingSourcesGet call and complete the assertions
          /*

          instance.fundingSourcesGet().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.FundingSourceReadAll);
