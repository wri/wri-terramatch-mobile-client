    ...
    describe('CarbonCertificationVersionsApi', function() {
      describe('carbonCertificationVersionsIDApprovePatch', function() {
        it('should call carbonCertificationVersionsIDApprovePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for carbonCertificationVersionsIDApprovePatch call and complete the assertions
          /*
          var ID = 56;

          instance.carbonCertificationVersionsIDApprovePatch(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationVersionRead);
            ...
            expect(data.data).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationRead);
              ...
              expect(data.data.other_value).to.be.a('string');
              // expect(data.data.other_value).to.be("");
              expect(data.data.link).to.be.a('string');
              // expect(data.data.link).to.be("");
      ...
      describe('carbonCertificationVersionsIDDelete', function() {
        it('should call carbonCertificationVersionsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for carbonCertificationVersionsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.carbonCertificationVersionsIDDelete(ID).then(function(data) {
            // TODO: update response assertions
      ...
      describe('carbonCertificationVersionsIDGet', function() {
        it('should call carbonCertificationVersionsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for carbonCertificationVersionsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.carbonCertificationVersionsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('carbonCertificationVersionsIDRejectPatch', function() {
        it('should call carbonCertificationVersionsIDRejectPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for carbonCertificationVersionsIDRejectPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.CarbonCertificationVersionReject();
          Body.rejected_reason = "";
          Body.rejected_reason_body = "";

          instance.carbonCertificationVersionsIDRejectPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('carbonCertificationVersionsIDRevivePatch', function() {
        it('should call carbonCertificationVersionsIDRevivePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for carbonCertificationVersionsIDRevivePatch call and complete the assertions
          /*
          var ID = 56;

          instance.carbonCertificationVersionsIDRevivePatch(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('carbonCertificationsIDCarbonCertificationVersionsGet', function() {
        it('should call carbonCertificationsIDCarbonCertificationVersionsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for carbonCertificationsIDCarbonCertificationVersionsGet call and complete the assertions
          /*
          var ID = 56;

          instance.carbonCertificationsIDCarbonCertificationVersionsGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationVersionReadAll);
