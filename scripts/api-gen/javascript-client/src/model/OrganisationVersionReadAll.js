...
import {OrganisationVersionRead} from './OrganisationVersionRead';
 ...
 * @version 1.0.0
 */
export class OrganisationVersionReadAll extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrganisationVersionReadAll();
