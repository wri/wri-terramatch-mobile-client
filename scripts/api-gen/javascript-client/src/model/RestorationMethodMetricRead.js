 ...
 * @version 1.0.0
 */
export class RestorationMethodMetricRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RestorationMethodMetricRead();
 ...
 * @member {Number} id
 */
RestorationMethodMetricRead.prototype.id = undefined;

/**
 * @member {Number} pitch_id
 */
RestorationMethodMetricRead.prototype.pitch_id = undefined;

/**
 * @member {String} restoration_method
 */
RestorationMethodMetricRead.prototype.restoration_method = undefined;

/**
 * @member {Number} experience
 */
RestorationMethodMetricRead.prototype.experience = undefined;

/**
 * @member {Number} land_size
 */
RestorationMethodMetricRead.prototype.land_size = undefined;

/**
 * @member {Number} price_per_hectare
 */
RestorationMethodMetricRead.prototype.price_per_hectare = undefined;

/**
 * @member {Number} biomass_per_hectare
 */
RestorationMethodMetricRead.prototype.biomass_per_hectare = undefined;

/**
 * @member {Number} carbon_impact
 */
RestorationMethodMetricRead.prototype.carbon_impact = undefined;

/**
 * @member {Array.<String>} species_impacted
 */
RestorationMethodMetricRead.prototype.species_impacted = undefined;

/**
 * @member {Date} created_at
 */
RestorationMethodMetricRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
RestorationMethodMetricRead.prototype.updated_at = undefined;
