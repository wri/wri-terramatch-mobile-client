 ...
 * @version 1.0.0
 */
export class MaskedOrganisationRead {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new MaskedOrganisationRead();
 ...
 * @member {Number} id
 */
MaskedOrganisationRead.prototype.id = undefined;

/**
 * @member {String} name
 */
MaskedOrganisationRead.prototype.name = undefined;

/**
 * @member {String} description
 */
MaskedOrganisationRead.prototype.description = undefined;

/**
 * @member {String} city
 */
MaskedOrganisationRead.prototype.city = undefined;

/**
 * @member {String} state
 */
MaskedOrganisationRead.prototype.state = undefined;

/**
 * @member {String} country
 */
MaskedOrganisationRead.prototype.country = undefined;

/**
 * @member {String} website
 */
MaskedOrganisationRead.prototype.website = undefined;

/**
 * @member {String} type
 */
MaskedOrganisationRead.prototype.type = undefined;

/**
 * @member {String} category
 */
MaskedOrganisationRead.prototype.category = undefined;

/**
 * @member {String} facebook
 */
MaskedOrganisationRead.prototype.facebook = undefined;

/**
 * @member {String} twitter
 */
MaskedOrganisationRead.prototype.twitter = undefined;

/**
 * @member {String} instagram
 */
MaskedOrganisationRead.prototype.instagram = undefined;

/**
 * @member {String} linkedin
 */
MaskedOrganisationRead.prototype.linkedin = undefined;

/**
 * @member {String} avatar
 */
MaskedOrganisationRead.prototype.avatar = undefined;

/**
 * @member {String} cover_photo
 */
MaskedOrganisationRead.prototype.cover_photo = undefined;

/**
 * @member {String} video
 */
MaskedOrganisationRead.prototype.video = undefined;

/**
 * @member {Date} founded_at
 */
MaskedOrganisationRead.prototype.founded_at = undefined;

/**
 * @member {Date} created_at
 */
MaskedOrganisationRead.prototype.created_at = undefined;

/**
 * @member {Date} updated_at
 */
MaskedOrganisationRead.prototype.updated_at = undefined;
