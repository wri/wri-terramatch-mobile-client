    ...
    describe('PitchVersionsApi', function() {
      describe('pitchVersionsIDApprovePatch', function() {
        it('should call pitchVersionsIDApprovePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchVersionsIDApprovePatch call and complete the assertions
          /*
          var ID = 56;

          instance.pitchVersionsIDApprovePatch(ID).then(function(data) {
      ...
      describe('pitchVersionsIDDelete', function() {
        it('should call pitchVersionsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchVersionsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.pitchVersionsIDDelete(ID).then(function(data) {
            // TODO: update response assertions
      ...
      describe('pitchVersionsIDGet', function() {
        it('should call pitchVersionsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchVersionsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.pitchVersionsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.PitchVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('pitchVersionsIDRejectPatch', function() {
        it('should call pitchVersionsIDRejectPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchVersionsIDRejectPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.PitchVersionReject();
          Body.rejected_reason = "";
          Body.rejected_reason_body = "";

          instance.pitchVersionsIDRejectPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.PitchVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('pitchVersionsIDRevivePatch', function() {
        it('should call pitchVersionsIDRevivePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchVersionsIDRevivePatch call and complete the assertions
          /*
          var ID = 56;

          instance.pitchVersionsIDRevivePatch(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.PitchVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('pitchesIDPitchVersionsGet', function() {
        it('should call pitchesIDPitchVersionsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for pitchesIDPitchVersionsGet call and complete the assertions
          /*
          var ID = 56;

          instance.pitchesIDPitchVersionsGet(ID).then(function(data) {
            // TODO: update response assertions
