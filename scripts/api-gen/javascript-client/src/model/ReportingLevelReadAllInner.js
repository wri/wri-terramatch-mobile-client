 ...
 * @version 1.0.0
 */
export class ReportingLevelReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ReportingLevelReadAllInner();
 ...
 * @member {String} name
 */
ReportingLevelReadAllInner.prototype.name = undefined;

/**
 * @member {String} level
 */
ReportingLevelReadAllInner.prototype.level = undefined;
