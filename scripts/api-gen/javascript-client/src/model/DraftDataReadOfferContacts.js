 ...
 * @version 1.0.0
 */
export class DraftDataReadOfferContacts {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DraftDataReadOfferContacts();
 ...
 */
DraftDataReadOfferContacts.prototype.user_id = undefined;

/**
 * @member {Number} team_member_id
 */
DraftDataReadOfferContacts.prototype.team_member_id = undefined;
