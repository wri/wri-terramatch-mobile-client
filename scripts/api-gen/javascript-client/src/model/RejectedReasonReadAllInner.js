 ...
 * @version 1.0.0
 */
export class RejectedReasonReadAllInner {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RejectedReasonReadAllInner();
 ...
 * @member {String} name
 */
RejectedReasonReadAllInner.prototype.name = undefined;

/**
 * @member {String} reason
 */
RejectedReasonReadAllInner.prototype.reason = undefined;
