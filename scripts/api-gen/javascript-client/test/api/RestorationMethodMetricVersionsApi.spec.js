    ...
    describe('RestorationMethodMetricVersionsApi', function() {
      describe('restorationMethodMetricVersionsIDApprovePatch', function() {
        it('should call restorationMethodMetricVersionsIDApprovePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for restorationMethodMetricVersionsIDApprovePatch call and complete the assertions
          /*
          var ID = 56;

          instance.restorationMethodMetricVersionsIDApprovePatch(ID).then(function(data) {
      ...
      describe('restorationMethodMetricVersionsIDDelete', function() {
        it('should call restorationMethodMetricVersionsIDDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for restorationMethodMetricVersionsIDDelete call and complete the assertions
          /*
          var ID = 56;

          instance.restorationMethodMetricVersionsIDDelete(ID).then(function(data) {
            // TODO: update response assertions
      ...
      describe('restorationMethodMetricVersionsIDGet', function() {
        it('should call restorationMethodMetricVersionsIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for restorationMethodMetricVersionsIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.restorationMethodMetricVersionsIDGet(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('restorationMethodMetricVersionsIDRejectPatch', function() {
        it('should call restorationMethodMetricVersionsIDRejectPatch successfully', function(done) {
          // TODO: uncomment, update parameter values for restorationMethodMetricVersionsIDRejectPatch call and complete the assertions
          /*
          var ID = 56;
          var Body = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionReject();
          Body.rejected_reason = "";
          Body.rejected_reason_body = "";

          instance.restorationMethodMetricVersionsIDRejectPatch(ID, Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('restorationMethodMetricVersionsIDRevivePatch', function() {
        it('should call restorationMethodMetricVersionsIDRevivePatch successfully', function(done) {
          // TODO: uncomment, update parameter values for restorationMethodMetricVersionsIDRevivePatch call and complete the assertions
          /*
          var ID = 56;

          instance.restorationMethodMetricVersionsIDRevivePatch(ID).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead);
            expect(data.id).to.be.a('number');
            // expect(data.id).to.be(0);
      ...
      describe('restorationMethodMetricsIDRestorationMethodMetricVersionsGet', function() {
        it('should call restorationMethodMetricsIDRestorationMethodMetricVersionsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for restorationMethodMetricsIDRestorationMethodMetricVersionsGet call and complete the assertions
          /*
          var ID = 56;

          instance.restorationMethodMetricsIDRestorationMethodMetricVersionsGet(ID).then(function(data) {
            // TODO: update response assertions
