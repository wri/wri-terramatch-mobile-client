    ...
    describe('CompatibilityScoresApi', function() {
      describe('compatibilityScoresPost', function() {
        it('should call compatibilityScoresPost successfully', function(done) {
          // TODO: uncomment, update parameter values for compatibilityScoresPost call and complete the assertions
          /*
          var Body = new WriRestorationMarketplaceApi.CompatibilityScoreCreate();
          Body.initiator = "";
          Body.offer_id = 0;
          Body.pitch_id = 0;

          instance.compatibilityScoresPost(Body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.InlineResponse200);
